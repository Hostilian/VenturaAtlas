...
> Convert assumptions into cheap tests and update rankings from real outcomes.
...
| What to build | Convert assumptions into cheap tests and update rankings from real outcomes. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. |
...
- **Canonical ID:** `idea-009`
- **Legacy ID:** `experiment-factory`
- **Slug:** `autonomous-experiment-factory`
- **Category:** Research tools / concept
- **Status:** explore
- **Tags:** experiments, validation, agents, analytics
- **Alternative names:** experiment-factory, Autonomous Experiment Factory
- **Source references:** src-002, src-012
- **Provenance status:** direct or reconstructed from supplied corpus; original wording: summary

Research produces documents but often fails to produce decisions, experiments, or learning loops. Convert assumptions into cheap tests and update rankings from real outcomes.
...
- **Functional:** Complete the workflow described by convert assumptions into cheap tests and update rankings from real outcomes. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. with measurable evidence.
...
- **Customer Pays Because:** The customer pays because convert assumptions into cheap tests and update rankings from real outcomes. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. can be tied to a concrete decision, release, transaction, or avoided cost.
...
### Core Features
- Convert assumptions into cheap tests and update rankings from real outcomes. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
...
- **Mvp Definition:** One complete vertical slice that delivers convert assumptions into cheap tests and update rankings from real outcomes. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. for one customer segment with a paid or behaviorally binding test.
...
- **Long Term Vision:** A trusted system of record and operating layer for the workflow surrounding Autonomous Experiment Factory.
...
- **Exact System:** Build a web application and bounded AI workflow for Autonomous Experiment Factory: Convert assumptions into cheap tests and update rankings from real outcomes. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
...
| recurringRevenuePotential | 8.4 | medium | Updates, releases, monitoring, transactions, or accumulated data can create repeat use. |
| grossMarginPotential | 8.3 | medium | Digital delivery can produce attractive margins after human review and support are controlled. |
...
| easeOfMvp | 7.4 | medium | A useful vertical slice is feasible without implementing the long-term platform. |
...
| scalability | 8.4 | medium | Software and reusable assets can scale beyond founder hours after the manual learning phase. |
...
- **Bootstrap Potential:** 79.1/100
- **Solo Founder Potential:** 80.3/100
- **Ai Agent Potential:** 89.6/100
- **Fastest Revenue:** 75.2/100
- **Highest Profit Potential:** 85.0/100
- **Lowest Cost Launch:** 72.8/100
- **Recurring Revenue:** 84.0/100
- **Enterprise Opportunity:** 85.9/100
- **Consumer Opportunity:** 78.3/100
- **Local Business Opportunity:** 76.7/100
- **Marketplace Opportunity:** 86.0/100
- **Long Term Defensibility:** 86.9/100
- **Nontechnical Founder:** 78.2/100
- **Technical Founder:** 87.7/100
- **Small Team:** 75.8/100
- **Little Capital:** 73.1/100
...
See [`prompts/idea-specific/idea-009/`](../prompts/idea-specific/idea-009/README.md).
