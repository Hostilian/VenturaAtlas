# Booked-Out Referral Exchange

> An outcome-based referral exchange enabling fully booked service providers to monetise unfulfillable customer inquiries.
...
|---|---|
| Idea ID | `idea-086` |
| Target customer | Solo service providers, photographers, coaches, specialized contractors |
| Problem | Wasted unfulfillable customer leads when calendar is 100% full |
| What to build | Simple SMS/Web lead routing dispatch form + commission ledger |
| How it makes money | 10–15% success fee on completed bookings, split with referring provider |
| Why customers pay | Receiving provider gets high-intent warm leads; referring provider monetises excess demand |
| Earning potential | EUR 2000–60000 annual scenario range; not a forecast |
| Startup cost | EUR 0–50 |
| Time to MVP | 3-7 days |
| Time to first revenue |  |
| Profitability condition |  |
| Overall opportunity score | 84.5/100 |
| Confidence | 7.8/10 |
| Main advantage | Taps into existing unserviced demand stream with zero marketing spend |
| Main risk | Two-sided cold-start problem in local micro-markets |
| Best next validation | Launch a manual pilot with 10 local photographers in one city |

## Identity and Provenance

- **Canonical ID:** `idea-086`
- **Legacy ID:** `booked-out-referral-exchange`
...
Discovered via 12-round deep research reset. Monetises rejected demand while solving lead generation for growing providers.
...
- **Customer Pays Because:** Receiving provider gets high-intent warm leads; referring provider monetises excess demand
...
### Core Features
- Simple SMS/Web lead routing dispatch form + commission ledger
...
- **Mvp Definition:** Simple SMS/Web lead routing dispatch form + commission ledger
...
- **Long Term Vision:** A trusted system of record and operating layer for the workflow surrounding Booked-Out Referral Exchange.
...
- **Exact System:** Build a web application and bounded AI workflow for Booked-Out Referral Exchange: Simple SMS/Web lead routing dispatch form + commission ledger
...
- **Value Proposition:** Receiving provider gets high-intent warm leads; referring provider monetises excess demand
...
| frequencyOfNeed | 7.5 | medium | — |
| willingnessToPay | 8.0 | high | — |
| marketDemand | 7.5 | medium | — |
| marketGrowth | — | medium | — |
| revenuePotential | — | medium | — |
| recurringRevenuePotential | — | medium | — |
| grossMarginPotential | — | medium | — |
| speedToFirstRevenue | 8.8 | high | — |
...
See [`prompts/idea-specific/idea-086/`](../prompts/idea-specific/idea-086/README.md).
