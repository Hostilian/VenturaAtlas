...
> A zero-risk 15% performance-fee service activating waitlists for appointment businesses to fill last-minute slots.
...
|---|---|
| Idea ID | `idea-084` |
| Target customer | Tattoo artists, pet groomers, boutique beauty salons, niche instructors |
| Problem | Unfilled late cancellations creating empty slots and lost income |
| What to build | Waitlist integration webhook + automated SMS responder |
| How it makes money | 15% performance fee on successfully recovered appointment revenue |
| Why customers pay | Zero risk; business pays only when previously lost revenue is recovered |
| Earning potential | EUR 2250–108000 annual scenario range; not a forecast |
...
| Confidence | 8.0/10 |
| Main advantage | No software subscription to sell, purely outcome-aligned revenue |
| Main risk | Attribution disputes over whether the customer would have booked anyway |
| Best next validation | Offer 5 local service businesses a 15% revenue share pilot for 30 days |

## Identity and Provenance

- **Canonical ID:** `idea-084`
- **Legacy ID:** `cancellation-revenue-recovery`
...
Discovered via 12-round deep research reset. Avoids building calendar software by acting as an outcome-based waitlist execution engine.
...
- **Customer Pays Because:** Zero risk; business pays only when previously lost revenue is recovered
...
### Core Features
- Waitlist integration webhook + automated SMS responder
...
- **Mvp Definition:** Waitlist integration webhook + automated SMS responder
...
- **Long Term Vision:** A trusted system of record and operating layer for the workflow surrounding Cancellation Revenue Recovery.
...
- **Exact System:** Build a web application and bounded AI workflow for Cancellation Revenue Recovery: Waitlist integration webhook + automated SMS responder
...
- **Value Proposition:** Zero risk; business pays only when previously lost revenue is recovered
...
|---|---:|---|---|
| problemSeverity | 8.0 | high | — |
| frequencyOfNeed | 8.5 | high | — |
...
| speedToFirstRevenue | 9.0 | high | — |
| lowStartupCost | 10.0 | high | — |
| easeOfMvp | 8.8 | high | — |
| aiAutomationPotential | 7.8 | medium | — |
...
See [`prompts/idea-specific/idea-084/`](../prompts/idea-specific/idea-084/README.md).
