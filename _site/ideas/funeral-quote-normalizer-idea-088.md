# Funeral Quote Normalizer

> A transparent quote comparison service standardising complex funeral provider estimates into itemised breakdown tables.
...
|---|---|
| Idea ID | `idea-088` |
| Target customer | Families managing end-of-life arrangements under time pressure |
| Problem | Opaque, uncomparable funeral director quotes and hidden fees |
| What to build | Quote parsing OCR template + itemised price comparison report |
| How it makes money | €49–€99 fixed concierge analysis fee per comparison report |
| Why customers pay | Saves hundreds to thousands of euros while removing stress during grief |
| Earning potential | EUR 1500–45000 annual scenario range; not a forecast |
| Startup cost | EUR 0–50 |
| Time to MVP | 3-7 days |
| Time to first revenue |  |
| Profitability condition |  |
| Overall opportunity score | 80.5/100 |
| Confidence | 7.2/10 |
| Main advantage | Massive financial savings for family; high emotional value |
| Main risk | Sensitive distribution channels and one-time demand per customer |
| Best next validation | Test consumer landing page explaining quote comparison benefits |

## Identity and Provenance

- **Canonical ID:** `idea-088`
- **Legacy ID:** `funeral-quote-normalizer`
...
Discovered via 12-round deep research reset. High customer savings potential during sensitive purchasing decisions.
...
- **Customer Pays Because:** Saves hundreds to thousands of euros while removing stress during grief
...
### Core Features
- Quote parsing OCR template + itemised price comparison report
...
- **Mvp Definition:** Quote parsing OCR template + itemised price comparison report
...
- **Long Term Vision:** A trusted system of record and operating layer for the workflow surrounding Funeral Quote Normalizer.
...
- **Exact System:** Build a web application and bounded AI workflow for Funeral Quote Normalizer: Quote parsing OCR template + itemised price comparison report
...
- **Value Proposition:** Saves hundreds to thousands of euros while removing stress during grief
...
| frequencyOfNeed | 4.0 | low | — |
| willingnessToPay | 8.0 | medium | — |
| marketDemand | 6.5 | medium | — |
| marketGrowth | — | medium | — |
...
- **Overall Opportunity:** 80.5/100
- **Bootstrap Potential:** 86.0/100
- **Solo Founder Potential:** 84.0/100
...
See [`prompts/idea-specific/idea-088/`](../prompts/idea-specific/idea-088/README.md).
