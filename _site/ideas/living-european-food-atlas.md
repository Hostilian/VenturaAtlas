# Living European Food Atlas

> Map-led catalog connecting regions, foods, producers, stories, and purchasing.
...
|---|---|
| Idea ID | `idea-041` |
| Target customer | food explorers |
| Problem | Food discovery, culture, evidence, and commerce are separated across weakly linked sources. |
| What to build | Map-led catalog connecting regions, foods, producers, stories, and purchasing. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. |
| How it makes money | commerce commission; premium guides; tourism partnerships; data licensing |
| Why customers pay | The customer pays because the product should produce a faster, safer, more measurable outcome than food explorers can obtain from current manual workarounds. |
...
| Overall opportunity score | 78.1/100 |
| Confidence | 7.8/10 |
| Main advantage | geospatial food ontology and verified producer/product relationships |
...
- **Canonical ID:** `idea-041`
- **Legacy ID:** `food-atlas`
- **Slug:** `living-european-food-atlas`
- **Category:** Food knowledge / build
- **Status:** explore
- **Tags:** maps, food, catalog, knowledge graph
- **Alternative names:** food-atlas, Living European Food Atlas
- **Source references:** src-002, src-012
- **Provenance status:** direct or reconstructed from supplied corpus; original wording: summary

Food discovery, culture, evidence, and commerce are separated across weakly linked sources. Map-led catalog connecting regions, foods, producers, stories, and purchasing.
...
- **Economic Buyer:** food explorers

- **Daily User:** retailers

- **Customer Type:** business, professional, creator, developer, consumer, or marketplace participant depending on segment

- **Current Situation:** food explorers currently combines manual research, spreadsheets, generic software, internal scripts, or human judgment to handle this workflow.

- **Specific Problem:** Food discovery, culture, evidence, and commerce are separated across weakly linked sources.
...
- **Functional:** Complete the workflow described by map-led catalog connecting regions, foods, producers, stories, and purchasing. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. with measurable evidence.
...
- **Customer Pays Because:** The customer pays because map-led catalog connecting regions, foods, producers, stories, and purchasing. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. can be tied to a concrete decision, release, transaction, or avoided cost.

- **Idea Satisfies Customer By:** The idea satisfies the customer by converting food discovery, culture, evidence, and commerce are separated across weakly linked sources. into a repeatable workflow with explicit inputs, outputs, evidence, and next actions.
...
### Core Features
- Map-led catalog connecting regions, foods, producers, stories, and purchasing. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
...
- **Mvp Definition:** One complete vertical slice that delivers map-led catalog connecting regions, foods, producers, stories, and purchasing. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. for one customer segment with a paid or behaviorally binding test.
...
- **Long Term Vision:** A trusted system of record and operating layer for the workflow surrounding Living European Food Atlas.
...
- **Exact System:** Build a web application and bounded AI workflow for Living European Food Atlas: Map-led catalog connecting regions, foods, producers, stories, and purchasing. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
...
- **Description:** The market consists of food explorers handling the recurring workflow behind food discovery, culture, evidence, and commerce are separated across weakly linked sources.
...
- **Data:** geospatial food ontology and verified producer/product relationships
...
- **Initial Niche:** food explorers

- **Icp:** A reachable food explorers experiencing the problem now, with authority or direct access to the budget owner.

- **Beachhead:** One language, platform, neighborhood, workflow, or integration where distribution is identifiable.

- **Positioning:** A specific, evidence-backed outcome for food explorers, not a generic AI tool.

- **Value Proposition:** Reduce the time, uncertainty, and failure risk in food discovery, culture, evidence, and commerce are separated across weakly linked sources.
...
- **First Customer Conversation:** Interview a currently affected food explorers about the last occurrence and ask for a paid pilot.
...
| marketGrowth | 8.1 | medium | Structural AI, digitization, marketplace, or information-fragmentation trends may support growth. |
...
| aiAutomationPotential | 7.9 | medium | AI can accelerate research, classification, generation, testing, and operations with approval gates. |
| easeOfDistribution | 7.1 | medium | There are identifiable channels, but channel access and conversion must be proven. |
| retentionPotential | 7.7 | medium | Stored history, reruns, workflow integration, or network value may support retention. |
| competitiveAdvantage | 9.2 | medium-high | The proposed wedge is more specific than a generic tool, though competitors can respond. |
...
| evidenceQuality | 7.5 | medium | The idea has recoverable source support, but most exact commercial assumptions remain unvalidated. |
...
- **Overall Opportunity:** 78.1/100
- **Bootstrap Potential:** 74.1/100
- **Solo Founder Potential:** 74.4/100
- **Ai Agent Potential:** 80.6/100
- **Fastest Revenue:** 72.9/100
- **Highest Profit Potential:** 78.7/100
- **Lowest Cost Launch:** 73.4/100
- **Recurring Revenue:** 76.6/100
- **Enterprise Opportunity:** 79.5/100
- **Consumer Opportunity:** 77.0/100
- **Local Business Opportunity:** 72.0/100
- **Marketplace Opportunity:** 84.3/100
- **Long Term Defensibility:** 88.8/100
- **Nontechnical Founder:** 73.1/100
- **Technical Founder:** 82.2/100
- **Small Team:** 71.7/100
- **Little Capital:** 72.0/100
- **High Capital Available:** 81.3/100
...
See [`prompts/idea-specific/idea-041/`](../prompts/idea-specific/idea-041/README.md).
