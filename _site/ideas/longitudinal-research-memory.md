...
> Know what changed, what was assumed, and which conclusions became stale.
...
| What to build | Know what changed, what was assumed, and which conclusions became stale. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. |
...
- **Canonical ID:** `idea-020`
- **Legacy ID:** `research-memory`
- **Slug:** `longitudinal-research-memory`
- **Category:** Research tools / concept
- **Status:** explore
- **Tags:** memory, research, provenance, freshness
- **Alternative names:** research-memory, Longitudinal Research Memory
- **Source references:** src-002, src-012
- **Provenance status:** direct or reconstructed from supplied corpus; original wording: summary

Research produces documents but often fails to produce decisions, experiments, or learning loops. Know what changed, what was assumed, and which conclusions became stale.
...
- **Functional:** Complete the workflow described by know what changed, what was assumed, and which conclusions became stale. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. with measurable evidence.
...
- **Customer Pays Because:** The customer pays because know what changed, what was assumed, and which conclusions became stale. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. can be tied to a concrete decision, release, transaction, or avoided cost.
...
### Core Features
- Know what changed, what was assumed, and which conclusions became stale. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
...
- **Mvp Definition:** One complete vertical slice that delivers know what changed, what was assumed, and which conclusions became stale. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. for one customer segment with a paid or behaviorally binding test.
...
- **Long Term Vision:** A trusted system of record and operating layer for the workflow surrounding Longitudinal Research Memory.
...
- **Exact System:** Build a web application and bounded AI workflow for Longitudinal Research Memory: Know what changed, what was assumed, and which conclusions became stale. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
...
| recurringRevenuePotential | 8.2 | medium | Updates, releases, monitoring, transactions, or accumulated data can create repeat use. |
...
| competitiveAdvantage | 8.9 | medium-high | The proposed wedge is more specific than a generic tool, though competitors can respond. |
...
| scalability | 8.6 | medium-high | Software and reusable assets can scale beyond founder hours after the manual learning phase. |
...
| globalPotential | 8.3 | medium | The underlying problem can cross borders, though the initial wedge may be local or language-specific. |
| timing | 8.4 | medium | Current technical and behavioral changes create an opening, but timing evidence must be rechecked. |
| evidenceQuality | 9.9 | medium-high | The idea has recoverable source support, but most exact commercial assumptions remain unvalidated. |
...
- **Bootstrap Potential:** 76.1/100
- **Solo Founder Potential:** 78.4/100
- **Ai Agent Potential:** 89.8/100
- **Fastest Revenue:** 70.2/100
- **Highest Profit Potential:** 85.2/100
- **Lowest Cost Launch:** 73.2/100
- **Recurring Revenue:** 83.6/100
- **Enterprise Opportunity:** 86.7/100
- **Consumer Opportunity:** 78.1/100
- **Local Business Opportunity:** 72.0/100
- **Marketplace Opportunity:** 87.7/100
- **Long Term Defensibility:** 90.6/100
- **Nontechnical Founder:** 75.2/100
- **Technical Founder:** 88.6/100
- **Small Team:** 73.8/100
- **Little Capital:** 71.2/100
- **High Capital Available:** 86.2/100
...
## Related Ideas
- [idea-008](research-to-startup-engine.md)
...
See [`prompts/idea-specific/idea-020/`](../prompts/idea-specific/idea-020/README.md).
