...
> An emergency replacement network finding certified sports referees and match officials for last-minute cancellations.
...
|---|---|
| Idea ID | `idea-087` |
| Target customer | Amateur sports leagues, youth tournament directors, adult rec leagues |
| Problem | Game forfeits caused by unreplaced last-minute referee cancellations |
| What to build | SMS dispatch queue matching game location/time to certified standby officials |
| How it makes money | €15–€25 urgent replacement fee per filled game assignment |
| Why customers pay | Prevents game forfeits, parent complaints, and scheduling chaos |
| Earning potential | EUR 1500–40000 annual scenario range; not a forecast |
| Startup cost | EUR 0–50 |
| Time to MVP | 3-7 days |
| Time to first revenue |  |
| Profitability condition |  |
| Overall opportunity score | 81.0/100 |
| Confidence | 7.5/10 |
| Main advantage | High urgency when cancellation occurs; solves genuine operational headache |
| Main risk | Certification & association alignment friction |
| Best next validation | Contact 10 local youth soccer/basketball league directors |

## Identity and Provenance

- **Canonical ID:** `idea-087`
- **Legacy ID:** `referee-rescue`
...
Discovered via 12-round deep research reset. Focuses on supply availability and urgent dispatch for sports associations.
...
- **Customer Pays Because:** Prevents game forfeits, parent complaints, and scheduling chaos
...
### Core Features
- SMS dispatch queue matching game location/time to certified standby officials
...
- **Mvp Definition:** SMS dispatch queue matching game location/time to certified standby officials
...
- **Long Term Vision:** A trusted system of record and operating layer for the workflow surrounding Referee Rescue.
...
- **Exact System:** Build a web application and bounded AI workflow for Referee Rescue: SMS dispatch queue matching game location/time to certified standby officials
...
- **Value Proposition:** Prevents game forfeits, parent complaints, and scheduling chaos
...
- **Overall Opportunity:** 81.0/100
- **Bootstrap Potential:** 88.0/100
- **Solo Founder Potential:** 86.0/100
...
See [`prompts/idea-specific/idea-087/`](../prompts/idea-specific/idea-087/README.md).
