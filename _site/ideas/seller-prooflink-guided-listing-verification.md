# Seller ProofLink — Guided Listing Verification

> Sellers embed a FactBounty-style capture link in their listings so prospective buyers can request one specific piece of guided, challenge-code-verified evidence directly from the seller — converting browsing hesitation into completed purchases.
...
|---|---|
| Idea ID | `idea-070` |
| Target customer | Second-hand marketplace sellers who want to differentiate their listings; buyers who want specific evidence from the actual seller |
| Problem | Buyers hesitate on listings that lack specific evidence; sellers lose sales to hesitation that a single verified fact could resolve. |
| What to build | A simple embeddable link/widget that sellers include in listings. Buyer clicks → posts a question → seller records evidence with challenge code → seller gets paid small evidence fee → listing converts. |
| How it makes money | Platform fee on each evidence request. Seller subscription for multi-listing access. API for marketplace platforms. |
| Why customers pay | Sellers pay to convert more listings; buyers pay to get evidence directly from the seller with tamper-evident capture. |
| Earning potential | EUR 200–60000 annual scenario range; not a forecast |
| Startup cost | EUR 0–100 |
| Time to MVP | 5–10 days |
| Time to first revenue | 3–10 days |
| Profitability condition |  |
| Overall opportunity score | 74.2/100 |
| Confidence | 5.8/10 |
| Main advantage | Sellers are motivated to provide evidence; platform network effect possible through marketplace API integrations |
| Main risk | Vinted, StockX, Swappa, and VidVerity already serve this space; sellers may refuse off-platform capture links to avoid liability |
| Best next validation |  |

## Identity and Provenance

- **Canonical ID:** `idea-070`
- **Legacy ID:** `seller-prooflink`
...
- **Alternative names:** Seller ProofLink, Listing Evidence Link, ProofLink for Sellers
- **Source references:** s16, s17, s18, s19, s21, s46
- **Provenance status:** Deep Research — Eighth Full Reset (2026-08-02)

Seller ProofLink is the seller-initiated, listing-level variant of FactBounty — complementary rather than competing. It targets sellers who want to differentiate their listings through verified evidence and buyers who prefer to get evidence directly from the person selling the item. This is closer to the VidVerity and Swappa model but adds the FactBounty challenge-code capture flow.


## Customer Perspective

- **Primary Customer:** Second-hand marketplace sellers who want to differentiate their listings; buyers on those platforms

- **Economic Buyer:** Second-hand marketplace sellers who want to differentiate their listings; buyers on those platforms

- **Daily User:** Second-hand marketplace sellers who want to differentiate their listings; buyers on those platforms
...
- **Specific Problem:** Buyers have specific questions about listed items that text descriptions and uploaded photos do not answer; sellers have no standard way to provide verified real-time evidence.
...
- **Customer Pays Because:** Sellers: higher conversion rate justifies small evidence fee. Buyers: the challenge-code capture provides tamper-evident evidence that uploaded photos cannot.
...
- **Mvp Definition:** A simple embeddable link/widget that sellers include in listings. Buyer clicks → posts a question → seller records evidence with challenge code → seller gets paid small evidence fee → listing converts.
...
- **Revenue model:** Platform fee on each evidence request. Seller subscription for multi-listing access. API for marketplace platforms.
...
|---|---:|---|---|
| problemSeverity | 7.5 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on problemSeverity criteria. |
| frequencyOfNeed | 7.4 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on frequencyOfNeed criteria. |
| willingnessToPay | 7.5 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on willingnessToPay criteria. |
| marketDemand | 7.3 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on marketDemand criteria. |
| marketGrowth | 7.3 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on marketGrowth criteria. |
| revenuePotential | 7.4 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on revenuePotential criteria. |
| recurringRevenuePotential | 8 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on recurringRevenuePotential criteria. |
| grossMarginPotential | 6.6 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on grossMarginPotential criteria. |
| speedToFirstRevenue | 6.9 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on speedToFirstRevenue criteria. |
| lowStartupCost | 8.1 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on lowStartupCost criteria. |
| easeOfMvp | 8 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on easeOfMvp criteria. |
| aiAutomationPotential | 7.8 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on aiAutomationPotential criteria. |
| easeOfDistribution | 7.8 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on easeOfDistribution criteria. |
| retentionPotential | 6.7 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on retentionPotential criteria. |
| competitiveAdvantage | 5 | medium | Many incumbents serve adjacent listing-verification needs — score reflects HIGH competition (5 = moderate-high intensity) |
| defensibility | 6.9 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on defensibility criteria. |
| dataAdvantagePotential | 6.5 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on dataAdvantagePotential criteria. |
| scalability | 7.4 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on scalability criteria. |
| founderAccessibility | 6.7 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on founderAccessibility criteria. |
| regulatorySimplicity | 6.9 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on regulatorySimplicity criteria. |
| operationalSimplicity | 6.8 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on operationalSimplicity criteria. |
| globalPotential | 7.9 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on globalPotential criteria. |
| timing | 7.7 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on timing criteria. |
| evidenceQuality | 6.6 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on evidenceQuality criteria. |
| overallConfidence | 5.8 | medium | Viable but crowded; best as FactBounty complement rather than standalone |

### Composite Views

- **Overall Opportunity:** 74.2/100
- **Fastest Revenue:** 82/100
- **Lowest Cost Launch:** 90/100
- **Marketplace Opportunity:** 70/100
...
- [idea-070](seller-prooflink-guided-listing-verification.md)

## Source References

- **s16**: See data/sources.json for full citation.
- **s17**: See data/sources.json for full citation.
- **s18**: See data/sources.json for full citation.
- **s19**: See data/sources.json for full citation.
- **s21**: See data/sources.json for full citation.
- **s46**: See data/sources.json for full citation.
...
See [`prompts/idea-specific/idea-070/`](../prompts/idea-specific/idea-070/README.md).
