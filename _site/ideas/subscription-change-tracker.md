# Subscription Change Tracker

> Alert users to verified price, feature, plan, and policy changes.
...
| What to build | Alert users to verified price, feature, plan, and policy changes. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. |
...
| Overall opportunity score | 81.5/100 |
| Confidence | 9.1/10 |
...
- **Canonical ID:** `idea-022`
- **Legacy ID:** `subscription-change`
- **Slug:** `subscription-change-tracker`
- **Category:** Information service / researched format
- **Status:** explore
- **Tags:** subscriptions, price tracking, SaaS, alerts
- **Alternative names:** subscription-change, Subscription Change Tracker
- **Source references:** src-002, src-012
- **Provenance status:** direct or reconstructed from supplied corpus; original wording: summary

People miss opportunities or absorb changes late because sources are scattered and time-sensitive. Alert users to verified price, feature, plan, and policy changes.
...
- **Functional:** Complete the workflow described by alert users to verified price, feature, plan, and policy changes. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. with measurable evidence.
...
- **Customer Pays Because:** The customer pays because alert users to verified price, feature, plan, and policy changes. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. can be tied to a concrete decision, release, transaction, or avoided cost.
...
### Core Features
- Alert users to verified price, feature, plan, and policy changes. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
...
- **Mvp Definition:** One complete vertical slice that delivers alert users to verified price, feature, plan, and policy changes. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. for one customer segment with a paid or behaviorally binding test.
...
- **Long Term Vision:** A trusted system of record and operating layer for the workflow surrounding Subscription Change Tracker.
...
| lowStartupCost | 8.2 | medium | The first validation can use static pages, open tools, and customer-funded usage. |
...
- **Overall Opportunity:** 81.5/100
- **Bootstrap Potential:** 82.8/100
- **Solo Founder Potential:** 83.8/100
- **Ai Agent Potential:** 85.7/100
- **Fastest Revenue:** 82.2/100
- **Highest Profit Potential:** 81.6/100
- **Lowest Cost Launch:** 82.5/100
- **Recurring Revenue:** 84.4/100
- **Enterprise Opportunity:** 81.0/100
- **Consumer Opportunity:** 78.5/100
- **Local Business Opportunity:** 81.4/100
- **Marketplace Opportunity:** 79.8/100
- **Long Term Defensibility:** 80.3/100
- **Nontechnical Founder:** 82.7/100
- **Technical Founder:** 83.4/100
- **Small Team:** 78.4/100
- **Little Capital:** 82.2/100
- **High Capital Available:** 79.8/100
...
See [`prompts/idea-specific/idea-022/`](../prompts/idea-specific/idea-022/README.md).
