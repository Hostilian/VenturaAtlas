# Financial model Prompt — Longitudinal Research Memory

You are working on **Longitudinal Research Memory**.

## Verified context supplied by the idea record
- Concept: Know what changed, what was assumed, and which conclusions became stale.
...
- Proposed product: Know what changed, what was assumed, and which conclusions became stale. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
