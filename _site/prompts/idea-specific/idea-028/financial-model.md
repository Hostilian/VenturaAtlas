# Financial model Prompt — FoodSpec Evidence Registry

You are working on **FoodSpec Evidence Registry**.

## Verified context supplied by the idea record
- Concept: Verified product-spec and compliance dossiers for food sellers and marketplaces.
...
- Proposed product: Verified product-spec and compliance dossiers for food sellers and marketplaces. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
