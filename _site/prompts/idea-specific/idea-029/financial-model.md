# Financial model Prompt — Verified Seller Onboarding API

You are working on **Verified Seller Onboarding API**.

## Verified context supplied by the idea record
- Concept: Identity, business, tax, bank, product, and evidence onboarding for sellers.
...
- Proposed product: Identity, business, tax, bank, product, and evidence onboarding for sellers. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
