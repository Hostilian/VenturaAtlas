...
const COLLECTION_ENUM_FIELDS = {
  ...
  stressScenarios: {
    ...
    stressType: ['INCUMBENT_BUNDLE', 'API_PRICE_3X', 'API_ACCESS_REMOVAL', 'MODEL_IMPROVEMENT_90_PERCENT', 'OPEN_SOURCE_EQUIVALENT', 'CUSTOMER_BUILD_TWO_DAYS', 'INTEROPERABILITY_OPENING', 'PLATFORM_LOCK_IN', 'PLATFORM_OPENING', 'SUPPLIER_ENTRY', 'CUSTOMER_CONSOLIDATION', 'COMPETITOR_ACQUISITION', 'ACQUISITION_TARGET_DEPENDENCE', 'STRUCTURAL_KILL_COMPOSITE'],
