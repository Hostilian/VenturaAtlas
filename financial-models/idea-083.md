# Financial Model — Wedding Lead Spend Forensics

## Model

- **Revenue Model:** €99–€299 per audit, or €39/month recurring quarterly monitoring
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-083`.

### Analyst Assumptions
- Target buyer willingness to pay: Saves hundreds to thousands in wasted advertising and directory subscriptions
