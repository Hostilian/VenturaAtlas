# Financial Model — Cancellation Revenue Recovery

## Model

- **Revenue Model:** 15% performance fee on successfully recovered appointment revenue
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-084`.

### Analyst Assumptions
- Target buyer willingness to pay: Zero risk; business pays only when previously lost revenue is recovered
