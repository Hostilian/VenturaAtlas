# Financial Model — Booked-Out Referral Exchange

## Model

- **Revenue Model:** 10–15% success fee on completed bookings, split with referring provider
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-086`.

### Analyst Assumptions
- Target buyer willingness to pay: Receiving provider gets high-intent warm leads; referring provider monetises excess demand
- Startup cost budget: EUR 0–50
