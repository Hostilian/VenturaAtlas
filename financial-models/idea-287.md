# Financial Model — DuctExchange — EU Civil Infrastructure Access Network

## Model

- **Revenue Model:** Completed-access transaction fees + percentage share of verified civil construction cost savings.
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-287`.

### Analyst Assumptions
- Target buyer willingness to pay: Saves up to 40-60% of civil construction capex and accelerates fibre network deployment times.
...
- **Target Customer:** EU fibre builders and utility/municipal infrastructure owners
- **Why Customers Pay:** Saves up to 40-60% of civil construction capex and accelerates fibre network deployment times.
