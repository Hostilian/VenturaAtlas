# Financial Model — ResilienceProof — Climate Resilience & Property Adaptation Verification Rail

## Model

- **Revenue Model:** Per-property verification fees + insurer portfolio API subscription fees.
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-290`.

### Analyst Assumptions
- Target buyer willingness to pay: Property owners get lower premiums; insurers reduce claim payouts and close the protection gap.
...
- **Target Customer:** Property insurers, mortgage lenders, and retrofitted property owners
- **Why Customers Pay:** Property owners get lower premiums; insurers reduce claim payouts and close the protection gap.
