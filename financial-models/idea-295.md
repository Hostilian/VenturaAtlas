# Financial Model — OEM Repair Fulfilment Rail — Right to Repair After-Sales Logistics Engine

## Model

- **Revenue Model:** Per-repair case management fees + spare parts fulfillment margin take rates.
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-295`.

### Analyst Assumptions
- Target buyer willingness to pay: Provides instant compliance with EU repair directives at a fraction of in-house network costs.
...
- **Target Customer:** Operations directors at small and mid-sized European electronics and appliance OEMs
- **Why Customers Pay:** Provides instant compliance with EU repair directives at a fraction of in-house network costs.
