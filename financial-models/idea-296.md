# Financial Model — Grid Equipment Cancellation Exchange — Secondary Transformer & Switchgear Allocation

## Model

- **Revenue Model:** Transaction fee (2-5%) on matched equipment transfers and slot reassignments.
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-296`.

### Analyst Assumptions
- Target buyer willingness to pay: Cuts project grid connection delays by 12-24 months by sourcing canceled inventory.
...
- **Target Customer:** EPC contractors, data centre developers, and utility project directors
- **Why Customers Pay:** Cuts project grid connection delays by 12-24 months by sourcing canceled inventory.
