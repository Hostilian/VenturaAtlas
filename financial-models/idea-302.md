# Financial Model — ControlRight — Contract-to-Land-Registry Preflight & Event Clock

## Model

- **Revenue Model:** Per-filing preflight fee (£49) or firm-wide subscription (£299/mo)
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-302`.

### Analyst Assumptions
- Target buyer willingness to pay: Avoid Land Registry notice rejections and statutory false-filing liabilities
...
- **Why Customers Pay:** Avoid Land Registry notice rejections and statutory false-filing liabilities
- **Main Risk:** Geographically limited to England & Wales property jurisdiction
