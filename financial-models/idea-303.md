# Financial Model — Publisher Rights Probe — AI Search Publisher Conduct & Attribution Monitor

## Model

- **Revenue Model:** Publisher audit subscription (£499/mo per publication group)
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-303`.

### Analyst Assumptions
- Target buyer willingness to pay: Enforce regulatory publisher rights established under UK CMA June 2026 conduct rules
- Startup cost budget: EUR 0–250
...
- **Why Customers Pay:** Enforce regulatory publisher rights established under UK CMA June 2026 conduct rules
- **Main Risk:** Probabilistic nature of AI search outputs making single-query proof difficult
