# Financial Model — Subscription Rights Chaos Lab — Recurring Payment State-Machine QA

## Model

- **Revenue Model:** Subscription testing SaaS (£199/mo per billing app)
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-306`.

### Analyst Assumptions
- Target buyer willingness to pay: Comply with UK Spring 2027 subscription law and reduce customer support chargebacks
...
- **Why Customers Pay:** Comply with UK Spring 2027 subscription law and reduce customer support chargebacks
- **Main Risk:** Major subscription billing platforms (Stripe Billing, Chargebee) absorbing basic reminders natively
