# Financial Model — Connected-Vehicle Origin Graph — MY2027 Vehicle Software Origin Compliance

## Model

- **Revenue Model:** Enterprise platform license (€5,000/mo) per vehicle model program
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-307`.

### Analyst Assumptions
- Target buyer willingness to pay: Avoid U.S. import bans and vehicle sales freezes under MY2027 BIS rules
- Startup cost budget: EUR 200–5000
...
- **Why Customers Pay:** Avoid U.S. import bans and vehicle sales freezes under MY2027 BIS rules
- **Main Risk:** Long enterprise sales cycles with Tier-1 automotive procurement departments
