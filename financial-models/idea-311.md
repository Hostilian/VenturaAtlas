# Financial Model — Finance Control Red Team — Synthetic Transaction Fraud & ERP Separation Tester

## Model

- **Revenue Model:** £750-2,500 per business process audit plus continuous control monitoring SaaS
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-311`.

### Analyst Assumptions
- Target buyer willingness to pay: Prevent multi-hundred-thousand-pound invoice fraud losses and fulfill statutory prevention duties
...
- **Why Customers Pay:** Prevent multi-hundred-thousand-pound invoice fraud losses and fulfill statutory prevention duties
- **Main Risk:** Complex enterprise ERP integration requirements (SAP/Oracle/NetSuite)
