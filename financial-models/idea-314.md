# Financial Model — APP Reimbursement Replay — Synthetic Scam Claim & Multi-Bank Clock Simulator

## Model

- **Revenue Model:** PSP test suite subscription (£750/mo) plus audit compliance reports
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-314`.

### Analyst Assumptions
- Target buyer willingness to pay: Avoid PSR regulatory penalties and optimize sending/receiving bank reimbursement allocations
...
- **Why Customers Pay:** Avoid PSR regulatory penalties and optimize sending/receiving bank reimbursement allocations
- **Main Risk:** High industry baseline reimbursement performance reducing urgency for smaller PSPs
