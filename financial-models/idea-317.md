# Financial Model — EES Carrier Journey Monitor — EU Entry/Exit System Synthetic API & Fallback Tester

## Model

- **Revenue Model:** Carrier testing SaaS (€1,500/mo per transport operator)
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-317`.

### Analyst Assumptions
- Target buyer willingness to pay: Avoid carrier fines for transporting non-compliant passengers and prevent port delays
- Startup cost budget: EUR 0–300
...
- **Why Customers Pay:** Avoid carrier fines for transporting non-compliant passengers and prevent port delays
- **Main Risk:** Official eu-LISA portal tools and dominant travel tech incumbents (Amadeus/SITA) occupying market
