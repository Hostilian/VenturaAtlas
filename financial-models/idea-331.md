# Financial Model — BaselineLock — Counterfactual Contract Engine
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-331`.
...
- **Target Customer:** Enterprise Procurement & CFOs
