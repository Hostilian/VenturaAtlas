# Financial Model — Supplier Recall CostSplit
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-336`.
...
- **Target Customer:** Automotive & Industrial Suppliers
