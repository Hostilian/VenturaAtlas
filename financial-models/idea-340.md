# Financial Model — Agent License Cost Graph
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-340`.
...
- **Target Customer:** IT Asset Managers & Enterprise SAM Leads
