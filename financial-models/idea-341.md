# Financial Model — EntityMandate — Legal Authority Graph for Companies + AI Agents
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-341`.
...
- **Target Customer:** Enterprise CFOs & B2B Procurement Leads
