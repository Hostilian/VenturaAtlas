# Financial Model — MandateCompiler — Corporate Authority Machine-Readable Compiler
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-344`.
...
- **Target Customer:** Legal Ops & Enterprise Identity Leads
