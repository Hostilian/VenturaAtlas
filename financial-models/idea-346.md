# Financial Model — DisclosureFirewall — Minimum-Disclosure Layer for EU Digital Identity
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-346`.
...
- **Target Customer:** EUDI Relying Parties & Identity Developers
