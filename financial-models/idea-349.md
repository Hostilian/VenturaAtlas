# Financial Model — B2B Agent Gateway — Legacy Supplier Machine-Buyable Adapter
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-349`.
...
- **Target Customer:** B2B Distributors & Procurement Platforms
