# Financial Model — EUDI Relying-Party Readiness Cloud
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-356`.
...
- **Target Customer:** EU E-Commerce & Banking Developers
