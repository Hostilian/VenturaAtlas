# Financial Model — MethaneMismatch — Methane Certification vs Satellite Observation Engine
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-370`.
...
- **Target Customer:** Energy Importers & Insurers
