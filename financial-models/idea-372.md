# Financial Model — CloudExit Drill — Continuous Cloud Portability & Data Act Exit Testing
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-372`.
...
- **Target Customer:** Enterprise Cloud Architects & CISOs
