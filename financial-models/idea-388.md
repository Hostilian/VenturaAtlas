# Financial Model — PermanenceDesk — Certified Carbon Removal Asset-Liability Management Ledger

## Model

- **Revenue Model:** Platform license (€1,500-€5,000/mo) + fee per tracked tCO2.
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-388`.

### Analyst Assumptions
- Target buyer willingness to pay: Comply with EU CRCF 2026 audit requirements and maintain defensible net-zero balance sheets.
...
- **Target Customer:** Carbon removal project developers, corporate carbon buyers, carbon insurers, and climate funds
- **Why Customers Pay:** Comply with EU CRCF 2026 audit requirements and maintain defensible net-zero balance sheets.
