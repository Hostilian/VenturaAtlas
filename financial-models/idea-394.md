# Financial Model — As-Built Carbon Drift — Building Passport Embodied Carbon Audit Engine

## Model

- **Revenue Model:** Project audit fee (€1,000-€4,000 per construction project).
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-394`.

### Analyst Assumptions
- Target buyer willingness to pay: Avoid greenwashing liability and secure green building certification bonuses.
...
- **Target Customer:** General contractors, real estate developers, sustainability consultants, and building certifiers
- **Why Customers Pay:** Avoid greenwashing liability and secure green building certification bonuses.
