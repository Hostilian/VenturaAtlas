# Financial Model — MethaneTrueUp / ContractOracle — Environmental Observation & Methane Contract Reconciliation Engine

## Model

- **Revenue Model:** Annual platform subscription + transaction fees on reconciled cargo volumes.
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-399`.

### Analyst Assumptions
- Target buyer willingness to pay: Avoids severe EU regulatory penalties and enforces contractual methane performance clauses.
...
- **Target Customer:** LNG importers, gas traders, and corporate energy buyers
- **Why Customers Pay:** Avoids severe EU regulatory penalties and enforces contractual methane performance clauses.
