# Financial Model — FuelEU Pooling Marketplace — Maritime FuelEU Compliance Pool Exchange [KILLED]

## Model

- **Revenue Model:** Pool clearing fees [N/A].
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-405`.

### Analyst Assumptions
- Target buyer willingness to pay: N/A — OceanScore and BetterSea already hold network dominance.
...
- **Target Customer:** Commercial vessel operators [KILLED]
- **Why Customers Pay:** N/A — OceanScore and BetterSea already hold network dominance.
