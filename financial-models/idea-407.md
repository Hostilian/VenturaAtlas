# Financial Model — AidGraph -- Public Money Graph Platform

## Model

- **Revenue Model:** Platform infrastructure: AidHeadroom per-audit fees + SubsidySignal subscriptions + eventual API licensing.
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-407`.

### Analyst Assumptions
- Target buyer willingness to pay: Group-resolution step confirmed painful by EU Council feedback and Czechia August 2026 bulk-upload register feature.
...
- **Target Customer:** Grant consultants, subsidy advisers, and B2B sales intelligence teams
- **Why Customers Pay:** Group-resolution step confirmed painful by EU Council feedback and Czechia August 2026 bulk-upload register feature.
- **Main Risk:** Governments intend to automate group-resolution by 2029. Pure calculator has known half-life. Must grow toward durable intelligence layer.
