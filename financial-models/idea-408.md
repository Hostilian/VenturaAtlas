# Financial Model — AidHeadroom -- De Minimis Group Headroom Audit

## Model

- **Revenue Model:** EUR99 per applicant audit (validation). EUR149/month adviser workspace (concierge). Usage-based complex group reviews.
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-408`.

### Analyst Assumptions
- Target buyer willingness to pay: A EUR100k-EUR250k grant application makes a EUR99 evidence audit negligible. Omission risks aid repayment or ineligibility.
...
- **Target Customer:** Independent EU grant consultants managing applications for corporate clients
- **Why Customers Pay:** A EUR100k-EUR250k grant application makes a EUR99 evidence audit negligible. Omission risks aid repayment or ineligibility.
- **Main Risk:** Official registers close gap by 2029; consultants may use Excel for simple clients; corporate-group data may become expensive
