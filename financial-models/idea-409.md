# Financial Model — SubsidySignal -- Public Aid Buying-Signal Intelligence

## Model

- **Revenue Model:** EUR49 founding brief (10-25 companies). EUR79-149/month recurring vertical subscription. Eventual outcome-tracking API.
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-409`.

### Analyst Assumptions
- Target buyer willingness to pay: Funding event under automation/digitalisation scheme = near-term buyer window before RFP. Competitors also in register = competitive intelligence value.
- Startup cost budget: EUR 0–20
...
- **Target Customer:** B2B industrial automation integrators, ERP vendors, industrial software suppliers targeting manufacturing or capital-intensive verticals
- **Why Customers Pay:** Funding event under automation/digitalisation scheme = near-term buyer window before RFP. Competitors also in register = competitive intelligence value.
- **Main Risk:** Aid event to buyer-intent correlation may be weak; records appear too late; scheme purposes too vague; established sales-intel vendors may add feed immediately
