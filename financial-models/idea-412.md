# Financial Model — ScrapRoute — Critical-Mineral Contract & Inventory Route-Shock Monitor
...
### Known Facts
- Opportunity identified and structured in canonical atlas under ID `idea-412`.
