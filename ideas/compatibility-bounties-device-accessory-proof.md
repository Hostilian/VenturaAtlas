# Compatibility Bounties — Device-Accessory Proof Exchange

> Buyers fund a specific owner to physically demonstrate that two exact products work together — camera body with cage, NAS with drive model, PC cooler with motherboard — with visual evidence for the exact revision.
...
|---|---|
| Idea ID | `idea-063` |
| Target customer | Electronics buyers, PC builders, photographers, and videographers needing exact compatibility proof for specific hardware revisions |
| Problem | Official compatibility matrices are incomplete across revisions and regional models; community knowledge is often wrong or outdated; firmware changes can invalidate previous results. |
| What to build | A bounty marketplace for compatibility demonstrations. Buyer specifies two exact products (with revision/firmware); owner demonstrates physical connection and function; result is linked to device-accessory pair ID. |
| How it makes money | Platform fee on each bounty. Unlock fee for reusable facts. Long-term: compatibility graph API for retailers and PC build configurators. |
| Why customers pay | A single wrong compatibility purchase can mean a returned cooler that scratches a motherboard, an adapter that fries a lens, or a drive that corrupts a NAS. A €10 compatibility proof is cheap insurance. |
| Earning potential | EUR 500–120000 annual scenario range; not a forecast |
...
| Confidence | 6.5/10 |
| Main advantage | Higher bounty value than measurements; clear buyer pain in high-value electronics categories |
| Main risk | Unsafe compatibility tests can damage equipment; liability exposure for safety-adjacent categories; strong free community alternatives for popular pairings |
| Best next validation |  |

## Identity and Provenance

- **Canonical ID:** `idea-063`
- **Legacy ID:** `compatibility-bounties`
...
- **Alternative names:** Compatibility Bounties, Device Pairing Proof Exchange, Fit & Function Bounty
- **Source references:** s22, s39, s40, s47
- **Provenance status:** Deep Research — Eighth Full Reset (2026-08-02)

Electronics accessories, NAS drives, camera gear, PC components, and vehicle cargo accessories all have compatibility that official documentation does not fully cover. Compatibility Bounties is a specialized bounty exchange for physical compatibility demonstration — not editorial claims, not AI inference, but actual evidence of two products working together.


## Customer Perspective

- **Primary Customer:** Electronics buyers and enthusiasts who need physical compatibility proof for specific hardware revisions before purchasing

- **Economic Buyer:** Electronics buyers and enthusiasts who need physical compatibility proof for specific hardware revisions before purchasing

- **Daily User:** Electronics buyers and enthusiasts who need physical compatibility proof for specific hardware revisions before purchasing
...
- **Specific Problem:** Official compatibility matrices and community databases often cover only popular configurations; regional models and hardware revisions are frequently missing.
...
- Compatibility databases (incomplete)
- Reddit/forums (often wrong or outdated)
- Manufacturer support (slow, generic answers)
- eBay compatibility data (user-reported, unverified)
...
- **Customer Pays Because:** A €7–€15 verified compatibility proof is far cheaper than a wrong accessory purchase, a returned item, or equipment damage.
...
- **Mvp Definition:** A bounty marketplace for compatibility demonstrations. Buyer specifies two exact products (with revision/firmware); owner demonstrates physical connection and function; result is linked to device-accessory pair ID.
...
- **Revenue model:** Platform fee on each bounty. Unlock fee for reusable facts. Long-term: compatibility graph API for retailers and PC build configurators.
...
### Mitigations
- Strict "non-electrical, non-safety-critical" restriction initially
- Explicit waiver for responder and buyer
- Consult legal counsel before expanding to electrical or high-current categories
...
|---|---:|---|---|
| problemSeverity | 8 | medium | Wrong compatibility purchases are costly in high-value electronics |
| frequencyOfNeed | 7.9 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on frequencyOfNeed criteria. |
| willingnessToPay | 7.5 | low | Higher bounty tolerance for high-value electronics compatibility |
| marketDemand | 8.8 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on marketDemand criteria. |
| marketGrowth | 7.6 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on marketGrowth criteria. |
| revenuePotential | 9.1 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on revenuePotential criteria. |
| recurringRevenuePotential | 9.4 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on recurringRevenuePotential criteria. |
| grossMarginPotential | 7.8 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on grossMarginPotential criteria. |
| speedToFirstRevenue | 7.6 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on speedToFirstRevenue criteria. |
| lowStartupCost | 10 | high | Same zero-cost mechanics as FactBounty |
| easeOfMvp | 9.1 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on easeOfMvp criteria. |
...
| retentionPotential | 7.5 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on retentionPotential criteria. |
| competitiveAdvantage | 8 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on competitiveAdvantage criteria. |
...
| dataAdvantagePotential | 9.2 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on dataAdvantagePotential criteria. |
...
| founderAccessibility | 8 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on founderAccessibility criteria. |
| regulatorySimplicity | 7.5 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on regulatorySimplicity criteria. |
| operationalSimplicity | 7.6 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on operationalSimplicity criteria. |
...
| timing | 8.7 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on timing criteria. |
| evidenceQuality | 8.7 | medium | Evaluated during Deep Research Eighth Reset tournament. Structural score based on evidenceQuality criteria. |
| overallConfidence | 6.5 | medium | Strong niche but safety risk creates legal complexity |

### Composite Views

- **Overall Opportunity:** 84.2/100
- **Bootstrap Potential:** 82/100
- **Solo Founder Potential:** 78/100
- **Fastest Revenue:** 88/100
- **Lowest Cost Launch:** 94/100
...
- **s22**: See data/sources.json for full citation.
...
See [`prompts/idea-specific/idea-063/`](../prompts/idea-specific/idea-063/README.md).
