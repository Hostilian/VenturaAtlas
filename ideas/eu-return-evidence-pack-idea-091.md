# EU Return Evidence Pack

> A self-service evidence tool generating legally sound dispute packs for EU e-commerce return refusals.
...
|---|---|
| Idea ID | `idea-091` |
| Target customer | EU consumers facing unlawful e-commerce return rejections or fee deductions |
| Problem | Merchant non-compliance with EU 14-day statutory right of withdrawal rules |
| What to build | Dispute intake wizard + EU consumer law citation generator |
| How it makes money | €9–€19 per generated dispute evidence dossier |
| Why customers pay | Recovers €50–€500 in wrongfully withheld return refunds |
| Earning potential | EUR 1000–20000 annual scenario range; not a forecast |
| Startup cost | EUR 0–50 |
| Time to MVP | 3-7 days |
| Time to first revenue |  |
| Profitability condition |  |
| Overall opportunity score | 75.0/100 |
| Confidence | 6.5/10 |
| Main advantage | Strong EU regulatory backing and clear consumer financial recovery |
| Main risk | One-off transaction model and legal disclaimer requirements |
| Best next validation | Post in EU consumer advice forums offering free pilot dispute packs |

## Identity and Provenance

- **Canonical ID:** `idea-091`
- **Legacy ID:** `eu-return-evidence-pack`
...
Discovered via 12-round deep research reset. Leverages EU Consumer Rights Directive protection rules.
...
- **Customer Pays Because:** Recovers €50–€500 in wrongfully withheld return refunds
...
### Core Features
- Dispute intake wizard + EU consumer law citation generator
...
- **Mvp Definition:** Dispute intake wizard + EU consumer law citation generator
...
- **Long Term Vision:** A trusted system of record and operating layer for the workflow surrounding EU Return Evidence Pack.
...
- **Exact System:** Build a web application and bounded AI workflow for EU Return Evidence Pack: Dispute intake wizard + EU consumer law citation generator
...
- **Value Proposition:** Recovers €50–€500 in wrongfully withheld return refunds
...
| frequencyOfNeed | 5.0 | low | — |
| willingnessToPay | 7.5 | medium | — |
| marketDemand | 6.2 | low | — |
| marketGrowth | — | medium | — |
...
| easeOfMvp | 8.5 | high | — |
| aiAutomationPotential | 8.5 | high | — |
...
- **Overall Opportunity:** 75.0/100
- **Bootstrap Potential:** 82.0/100
- **Solo Founder Potential:** 80.0/100
...
See [`prompts/idea-specific/idea-091/`](../prompts/idea-specific/idea-091/README.md).
