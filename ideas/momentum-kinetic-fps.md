# Momentum / Kinetic FPS

> Movement-first Unreal Engine 5 shooter built through modular systems and play telemetry.
...
|---|---|
| Idea ID | `idea-050` |
| Target customer | movement-shooter players |
| Problem | Game prototypes lack a disciplined loop from mechanics to play evidence and packaged builds. |
| What to build | Movement-first Unreal Engine 5 shooter built through modular systems and play telemetry. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. |
| How it makes money | premium game; early access; cosmetics; level packs |
| Why customers pay | The customer pays because the product should produce a faster, safer, more measurable outcome than movement-shooter players can obtain from current manual workarounds. |
...
| Overall opportunity score | 73.4/100 |
| Confidence | 6.8/10 |
| Main advantage | distinct movement feel, levels, community maps, and replay data |
...
- **Canonical ID:** `idea-050`
- **Legacy ID:** `momentum-fps`
- **Slug:** `momentum-kinetic-fps`
- **Category:** Games / planning stage
- **Status:** explore
- **Tags:** Unreal Engine 5, FPS, movement, game agents
- **Alternative names:** momentum-fps, Momentum / Kinetic FPS
- **Source references:** src-010, src-012
- **Provenance status:** direct or reconstructed from supplied corpus; original wording: summary

Game prototypes lack a disciplined loop from mechanics to play evidence and packaged builds. Movement-first Unreal Engine 5 shooter built through modular systems and play telemetry.


## Customer Perspective

- **Primary Customer:** movement-shooter players

- **Economic Buyer:** movement-shooter players

- **Daily User:** streamers

- **Customer Type:** business, professional, creator, developer, consumer, or marketplace participant depending on segment

- **Current Situation:** movement-shooter players currently combines manual research, spreadsheets, generic software, internal scripts, or human judgment to handle this workflow.

- **Specific Problem:** Game prototypes lack a disciplined loop from mechanics to play evidence and packaged builds.
...
- **Functional:** Complete the workflow described by movement-first unreal engine 5 shooter built through modular systems and play telemetry. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. with measurable evidence.
...
- **Customer Pays Because:** The customer pays because movement-first unreal engine 5 shooter built through modular systems and play telemetry. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. can be tied to a concrete decision, release, transaction, or avoided cost.

- **Idea Satisfies Customer By:** The idea satisfies the customer by converting game prototypes lack a disciplined loop from mechanics to play evidence and packaged builds. into a repeatable workflow with explicit inputs, outputs, evidence, and next actions.
...
### Core Features
- Movement-first Unreal Engine 5 shooter built through modular systems and play telemetry. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
...
- **Mvp Definition:** One complete vertical slice that delivers movement-first unreal engine 5 shooter built through modular systems and play telemetry. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. for one customer segment with a paid or behaviorally binding test.
...
- **Long Term Vision:** A trusted system of record and operating layer for the workflow surrounding Momentum / Kinetic FPS.
...
- **Exact System:** Build a web application and bounded AI workflow for Momentum / Kinetic FPS: Movement-first Unreal Engine 5 shooter built through modular systems and play telemetry. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
...
- **Description:** The market consists of movement-shooter players handling the recurring workflow behind game prototypes lack a disciplined loop from mechanics to play evidence and packaged builds.
...
- **Data:** distinct movement feel, levels, community maps, and replay data
...
- **Initial Niche:** movement-shooter players

- **Icp:** A reachable movement-shooter players experiencing the problem now, with authority or direct access to the budget owner.

- **Beachhead:** One language, platform, neighborhood, workflow, or integration where distribution is identifiable.

- **Positioning:** A specific, evidence-backed outcome for movement-shooter players, not a generic AI tool.

- **Value Proposition:** Reduce the time, uncertainty, and failure risk in game prototypes lack a disciplined loop from mechanics to play evidence and packaged builds.
...
- **Build Difficulty:** 5.3

- **Operational Difficulty:** 5.3
...
- **First Customer Conversation:** Interview a currently affected movement-shooter players about the last occurrence and ask for a paid pilot.
...
|---|---:|---|---|
| problemSeverity | 7.7 | medium | The problem can create material delay, cost, error, lost revenue, or frustration for the named user. |
...
| willingnessToPay | 7.3 | medium | A plausible budget owner exists, although exact willingness to pay is an assumption until prepayment. |
| marketDemand | 7.8 | medium | The underlying workflow appears broadly relevant; accessible demand is narrower than total-market rhetoric. |
...
| recurringRevenuePotential | 7.4 | medium | Updates, releases, monitoring, transactions, or accumulated data can create repeat use. |
...
| speedToFirstRevenue | 5.6 | medium | A narrow paid pilot can precede full software if distribution reaches the buyer. |
| lowStartupCost | 5.8 | medium | The first validation can use static pages, open tools, and customer-funded usage. |
| easeOfMvp | 5.7 | medium | A useful vertical slice is feasible without implementing the long-term platform. |
| aiAutomationPotential | 8.6 | medium-high | AI can accelerate research, classification, generation, testing, and operations with approval gates. |
...
| defensibility | 7.7 | medium | Data, integrations, workflow history, brand trust, or network density could compound. |
| dataAdvantagePotential | 7.8 | medium | Usage can create structured, permission-safe outcome data if collection is designed carefully. |
...
| regulatorySimplicity | 5.8 | medium | Risk is manageable only with explicit scope boundaries, privacy controls, and legal review where relevant. |
| operationalSimplicity | 5.7 | medium | The product can be standardized, but support, review, or partner operations may remain. |
| globalPotential | 7.7 | medium | The underlying problem can cross borders, though the initial wedge may be local or language-specific. |
| timing | 7.5 | medium | Current technical and behavioral changes create an opening, but timing evidence must be rechecked. |
...
- **Overall Opportunity:** 73.4/100
- **Bootstrap Potential:** 65.6/100
- **Solo Founder Potential:** 69.5/100
- **Ai Agent Potential:** 77.4/100
- **Fastest Revenue:** 61.1/100
- **Highest Profit Potential:** 74.3/100
- **Lowest Cost Launch:** 62.6/100
- **Recurring Revenue:** 73.8/100
- **Enterprise Opportunity:** 73.8/100
- **Consumer Opportunity:** 72.6/100
- **Local Business Opportunity:** 63.9/100
- **Marketplace Opportunity:** 77.4/100
- **Long Term Defensibility:** 78.2/100
- **Nontechnical Founder:** 65.9/100
- **Technical Founder:** 76.2/100
- **Small Team:** 66.0/100
- **Little Capital:** 59.9/100
- **High Capital Available:** 75.6/100


## Evidence, Assumptions, and Unknowns

### Evidence
- source_record — The concept or close variant appears in the supplied corpus. (medium; src-010)
...
See [`prompts/idea-specific/idea-050/`](../prompts/idea-specific/idea-050/README.md).
