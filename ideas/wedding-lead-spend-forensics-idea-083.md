# Wedding Lead Spend Forensics

> A €99–€299 productized audit analyzing inquiry logs for wedding vendors to identify unviable lead channels.
...
|---|---|
| Idea ID | `idea-083` |
| Target customer | Wedding photographers, DJs, planners, florists, and venues |
| Problem | High listing fees spent on unqualified, unresponsive, or low-intent lead channels |
| What to build | CSV/export parser + automated P&L & lead attribution report generator |
| How it makes money | €99–€299 per audit, or €39/month recurring quarterly monitoring |
| Why customers pay | Saves hundreds to thousands in wasted advertising and directory subscriptions |
| Earning potential | EUR 4700–76000 annual scenario range; not a forecast |
| Startup cost | EUR 0–50 |
| Time to MVP | 3-7 days |
| Time to first revenue |  |
| Profitability condition |  |
| Overall opportunity score | 87.5/100 |
| Confidence | 8.2/10 |
| Main advantage | High dollar savings for customer, immediate willingness to pay, repeatable template |
| Main risk | Audit execution time per client must be kept under 3 hours |
| Best next validation | Offer 10 wedding vendors a €99 audit with €25 upfront deposit |

## Identity and Provenance

- **Canonical ID:** `idea-083`
- **Legacy ID:** `wedding-lead-spend-forensics`
...
Discovered via 12-round deep research reset. Avoids controversial fake-lead accusations by auditing vendor-owned inquiry data to reveal true channel performance.
...
- **Customer Pays Because:** Saves hundreds to thousands in wasted advertising and directory subscriptions
...
### Core Features
- CSV/export parser + automated P&L & lead attribution report generator
...
- **Mvp Definition:** CSV/export parser + automated P&L & lead attribution report generator
...
- **Long Term Vision:** A trusted system of record and operating layer for the workflow surrounding Wedding Lead Spend Forensics.
...
- **Exact System:** Build a web application and bounded AI workflow for Wedding Lead Spend Forensics: CSV/export parser + automated P&L & lead attribution report generator
...
- **Value Proposition:** Saves hundreds to thousands in wasted advertising and directory subscriptions
...
|---|---:|---|---|
| problemSeverity | 8.5 | high | — |
| frequencyOfNeed | 6.5 | medium | — |
| willingnessToPay | 8.8 | high | — |
| marketDemand | 7.8 | medium | — |
| marketGrowth | — | medium | — |
| revenuePotential | — | medium | — |
| recurringRevenuePotential | — | medium | — |
| grossMarginPotential | — | medium | — |
| speedToFirstRevenue | 9.2 | high | — |
| lowStartupCost | 10.0 | high | — |
| easeOfMvp | 8.5 | high | — |
| aiAutomationPotential | 8.0 | medium | — |
...
- **Overall Opportunity:** 87.5/100
- **Bootstrap Potential:** 92.0/100
- **Solo Founder Potential:** 90.0/100
...
See [`prompts/idea-specific/idea-083/`](../prompts/idea-specific/idea-083/README.md).
