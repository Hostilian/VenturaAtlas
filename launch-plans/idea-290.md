# Launch Plan — ResilienceProof — Climate Resilience & Property Adaptation Verification Rail

## Go-to-Market

- **Initial Niche:** Property insurers, mortgage lenders, and retrofitted property owners
- **ICP:** Property insurers, mortgage lenders, and retrofitted property owners
- **Positioning:** A specialized, fast, low-friction solution for Lack of verified, trustworthy physical adaptation evidence needed for insurance discounts.
- **Value Proposition:** Property owners get lower premiums; insurers reduce claim payouts and close the protection gap.
