# Launch Plan — OEM Repair Fulfilment Rail — Right to Repair After-Sales Logistics Engine

## Go-to-Market

- **Initial Niche:** Operations directors at small and mid-sized European electronics and appliance OEMs
- **ICP:** Operations directors at small and mid-sized European electronics and appliance OEMs
- **Positioning:** A specialized, fast, low-friction solution for Mandatory EU repair compliance burden without dense local service network infrastructure.
- **Value Proposition:** Provides instant compliance with EU repair directives at a fraction of in-house network costs.
