# Launch Plan — Grid Equipment Cancellation Exchange — Secondary Transformer & Switchgear Allocation

## Go-to-Market

- **Initial Niche:** EPC contractors, data centre developers, and utility project directors
- **ICP:** EPC contractors, data centre developers, and utility project directors
- **Positioning:** A specialized, fast, low-friction solution for Multi-year transformer procurement lead times delaying high-value energy projects.
- **Value Proposition:** Cuts project grid connection delays by 12-24 months by sourcing canceled inventory.
