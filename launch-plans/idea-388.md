# Launch Plan — PermanenceDesk — Certified Carbon Removal Asset-Liability Management Ledger

## Go-to-Market

- **Initial Niche:** Carbon removal project developers, corporate carbon buyers, carbon insurers, and climate funds
- **ICP:** Carbon removal project developers, corporate carbon buyers, carbon insurers, and climate funds
- **Positioning:** A specialized, fast, low-friction solution for Unquantified reversal liabilities and uncoordinated buffer pool contributions over 10-to-100 year carbon storage horizons.
- **Value Proposition:** Comply with EU CRCF 2026 audit requirements and maintain defensible net-zero balance sheets.
...
- **First Action:** Contact 20 targeted prospects with an immediate pilot offer
