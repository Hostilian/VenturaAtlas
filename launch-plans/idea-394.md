# Launch Plan — As-Built Carbon Drift — Building Passport Embodied Carbon Audit Engine

## Go-to-Market

- **Initial Niche:** General contractors, real estate developers, sustainability consultants, and building certifiers
- **ICP:** General contractors, real estate developers, sustainability consultants, and building certifiers
- **Positioning:** A specialized, fast, low-friction solution for Unnoticed embodied carbon increases caused by contractor material substitutions breaching EPBD building passport targets.
- **Value Proposition:** Avoid greenwashing liability and secure green building certification bonuses.
