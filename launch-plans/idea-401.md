# Launch Plan — CRA ReachLedger — Firmware Vulnerability Exposure & Patch Deployment Reachability Graph

## Go-to-Market

- **Initial Niche:** IoT hardware manufacturers, industrial device OEMs, and cybersecurity compliance officers
- **ICP:** IoT hardware manufacturers, industrial device OEMs, and cybersecurity compliance officers
- **Positioning:** A specialized, fast, low-friction solution for Inability to determine exact deployed serial number exposure and patch reachability under CRA deadlines.
- **Value Proposition:** Fulfills statutory EU Cyber Resilience Act reporting mandates and prevents non-compliance penalties.
