# Launch Plan — FuelEU Pooling Marketplace — Maritime FuelEU Compliance Pool Exchange [KILLED]

## Go-to-Market

- **Initial Niche:** Commercial vessel operators [KILLED]
- **ICP:** Commercial vessel operators [KILLED]
- **Positioning:** A specialized, fast, low-friction solution for FuelEU Maritime pooling matching [SOLVED BY EXISTING ENTRANTS].
- **Value Proposition:** N/A — OceanScore and BetterSea already hold network dominance.
