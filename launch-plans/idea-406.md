# Launch Plan — Generic Methane Certification/MRV — Commodity Gas Methane MRV & Registry Platform [KILLED]

## Go-to-Market

- **Initial Niche:** Upstream gas producers [KILLED]
- **ICP:** Upstream gas producers [KILLED]
- **Positioning:** A specialized, fast, low-friction solution for Methane certification and MRV [DOMINATED BY INCUMBENTS].
- **Value Proposition:** N/A — MiQ and Xpansiv dominate market infrastructure.
