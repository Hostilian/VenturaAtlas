# Weekly KPI review Prompt — Content Opportunity Ranker

You are working on **Content Opportunity Ranker**.

## Verified context supplied by the idea record
- Concept: Rank content formats by urgency, monetization, evidence, competition, and AI fit.
...
- Proposed product: Rank content formats by urgency, monetization, evidence, competition, and AI fit. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
