# Financial model Prompt — Evidence-Backed Recommendation Engine

You are working on **Evidence-Backed Recommendation Engine**.

## Verified context supplied by the idea record
- Concept: Recommendations driven by explicit criteria, primary sources, confidence, and updates.
...
- Proposed product: Recommendations driven by explicit criteria, primary sources, confidence, and updates. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
