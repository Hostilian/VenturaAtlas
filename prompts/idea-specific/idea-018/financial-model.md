# Financial model Prompt — Verified Agent Skill Marketplace

You are working on **Verified Agent Skill Marketplace**.

## Verified context supplied by the idea record
- Concept: Marketplace for agent skills with permissions, tests, benchmarks, and provenance.
...
- Proposed product: Marketplace for agent skills with permissions, tests, benchmarks, and provenance. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
