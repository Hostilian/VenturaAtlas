# Financial model Prompt — API Opportunity Ranker

You are working on **API Opportunity Ranker**.

## Verified context supplied by the idea record
- Concept: Rank API business ideas by revenue, users, defensibility, cost, and speed.
...
- Proposed product: Rank API business ideas by revenue, users, defensibility, cost, and speed. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
- Revenue paths: team subscriptions and research credits
- Main risk: unclear first wedge
- Current confidence: 7.6/10
