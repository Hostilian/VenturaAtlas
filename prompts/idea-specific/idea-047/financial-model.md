# Financial model Prompt — Autonomous Game Factory

You are working on **Autonomous Game Factory**.

## Verified context supplied by the idea record
- Concept: Multi-agent game prototyping, testing, packaging, telemetry, and iteration.
...
- Proposed product: Multi-agent game prototyping, testing, packaging, telemetry, and iteration. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
- Revenue paths: factory subscription and template marketplace
- Main risk: unclear first wedge
- Current confidence: 6.9/10
