#!/usr/bin/env node
/**
 * scripts/merge-omega-xviib-ideas.js
 *
 * Merges data/omega-xviib-ideas-ingest.json into data/ideas.json.
 * Idempotent: skips any idea whose ID already exists in ideas.json.
 *
 * Usage:
 *   node scripts/merge-omega-xviib-ideas.js
 *
...
const INGEST_PATH = path.join(__dirname, '..', 'data', 'omega-xviib-ideas-ingest.json');

console.log('Loading ideas.json...');
const ideasData = JSON.parse(fs.readFileSync(IDEAS_PATH, 'utf8'));

console.log('Loading omega-xviib-ideas-ingest.json...');
