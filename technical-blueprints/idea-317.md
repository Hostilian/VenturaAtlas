# Technical Blueprint — EES Carrier Journey Monitor — EU Entry/Exit System Synthetic API & Fallback Tester

## System

- **Exact System:** Synthetic passenger verification probe and API fallback parity analyzer
