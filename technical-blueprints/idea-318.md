# Technical Blueprint — ETIAS Carrier Preflight — Travel Authorization Pre-Boarding Exception Checker

## System

- **Exact System:** Lightweight ETIAS status preflight API and carrier exception dashboard
