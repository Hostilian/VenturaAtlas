# Technical Blueprint — EnergyShare Auditor — Peer-to-Peer Energy Allocation & Billing Audit Engine

## System

- **Exact System:** Smart meter telemetry parser, 15-min netting engine, tariff rule validator, and community billing export.
