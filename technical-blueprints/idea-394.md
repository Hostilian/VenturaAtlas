# Technical Blueprint — As-Built Carbon Drift — Building Passport Embodied Carbon Audit Engine

## System

- **Exact System:** BIM vs delivery docket parser, EPD matching engine, carbon variance log, and EPBD passport exporter.
