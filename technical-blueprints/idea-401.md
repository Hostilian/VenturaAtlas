# Technical Blueprint — CRA ReachLedger — Firmware Vulnerability Exposure & Patch Deployment Reachability Graph

## System

- **Exact System:** Serial-number-level vulnerability exposure graph and patch delivery audit ledger.
