# Technical Blueprint — AidGraph -- Public Money Graph Platform

## System

- **Exact System:** Shared entity-resolution graph: legal entities + control relationships + Member State + de minimis awards + scheme purpose + rolling 3-year window. Consumed by AidHeadroom and SubsidySignal product lines.
