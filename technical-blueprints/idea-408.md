# Technical Blueprint — AidHeadroom -- De Minimis Group Headroom Audit

## System

- **Exact System:** Concierge PDF report: applicant + candidate single undertaking + included prior awards + remaining headroom + proposed award + evidence links + unresolved issues + AMBER/GREEN/RED conclusion. No autonomous legal conclusions about group control.
