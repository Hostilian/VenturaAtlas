# Technical Blueprint — RiceGuard -- Preferential-Tariff Safeguard PO Risk

## System

- **Exact System:** PO-level tariff scenario: PO + country + rice category + current EU import volume vs threshold + safeguard state + ETA + tariff scenario delta.
