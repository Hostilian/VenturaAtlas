# Technical Blueprint — WorkerChainReceipt -- UK Contractor RTW Evidence Chain

## System

- **Exact System:** Shared evidence chain: worker + check + document + expiry + chain-visible receipt per tier.
