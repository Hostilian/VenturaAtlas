# Validation Plan — Vendor Slot Rescue

## Experiments

- **Most Important Uncertainty:** Will Craft market, food fair, and pop-up event organizers pay for this solution before expense?
- **Riskiest Assumption:** Organizers' existing waitlists might fill slots without third-party help
- **Cheapest Test:** Contact 30 local market organizers and offer 24h short-notice fill pilot
- **Fastest Test:** Direct outreach to 10 prospective buyers with an immediate delivery pilot.

### Interview Plan
- Interview 15 target buyers (Craft market, food fair, and pop-up event organizers).
