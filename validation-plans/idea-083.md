# Validation Plan — Wedding Lead Spend Forensics

## Experiments

- **Most Important Uncertainty:** Will Wedding photographers, DJs, planners, florists, and venues pay for this solution before expense?
- **Riskiest Assumption:** Audit execution time per client must be kept under 3 hours
- **Cheapest Test:** Offer 10 wedding vendors a €99 audit with €25 upfront deposit
- **Fastest Test:** Direct outreach to 10 prospective buyers with an immediate delivery pilot.

### Interview Plan
- Interview 15 target buyers (Wedding photographers, DJs, planners, florists, and venues).
