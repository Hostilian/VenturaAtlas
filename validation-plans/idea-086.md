# Validation Plan — Booked-Out Referral Exchange

## Experiments

- **Most Important Uncertainty:** Will Solo service providers, photographers, coaches, specialized contractors pay for this solution before expense?
- **Riskiest Assumption:** Two-sided cold-start problem in local micro-markets
- **Cheapest Test:** Launch a manual pilot with 10 local photographers in one city
- **Fastest Test:** Direct outreach to 10 prospective buyers with an immediate delivery pilot.

### Interview Plan
- Interview 15 target buyers (Solo service providers, photographers, coaches, specialized contractors).
