# Validation Plan — Wastewater EPR Settlement Rail — Pharma & Cosmetics Micropollutant Clearing Network

## Experiments

- **Most Important Uncertainty:** Will National Producer Responsibility Organisations (PROs), pharma/cosmetic producers, and wastewater utilities pay for this solution before expense?
- **Riskiest Assumption:** Current manual alternatives are perceived as sufficient
- **Cheapest Test:** Contact 20 qualified prospects with a fixed-price paid outcome offer
- **Fastest Test:** Direct outreach to 10 prospective buyers with an immediate delivery pilot.

### Interview Plan
- Interview 15 target buyers (National Producer Responsibility Organisations (PROs), pharma/cosmetic producers, and wastewater utilities).
