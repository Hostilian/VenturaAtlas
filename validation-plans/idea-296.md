# Validation Plan — Grid Equipment Cancellation Exchange — Secondary Transformer & Switchgear Allocation

## Experiments

- **Most Important Uncertainty:** Will EPC contractors, data centre developers, and utility project directors pay for this solution before expense?
...
### Interview Plan
- Interview 15 target buyers (EPC contractors, data centre developers, and utility project directors).
