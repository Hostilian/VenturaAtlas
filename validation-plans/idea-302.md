# Validation Plan — ControlRight — Contract-to-Land-Registry Preflight & Event Clock

## Experiments

- **Most Important Uncertainty:** Will UK conveyancing law firms, property developers, and land agents pay for this solution before expense?
- **Riskiest Assumption:** Geographically limited to England & Wales property jurisdiction
- **Cheapest Test:** Preflight 10 real UK option agreements for regional property law firms
- **Fastest Test:** Direct outreach to 10 prospective buyers with an immediate delivery pilot.

### Interview Plan
- Interview 15 target buyers (UK conveyancing law firms, property developers, and land agents).
