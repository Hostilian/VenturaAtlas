# Validation Plan — CLP Render-to-Shelf Drift Gate — Chemical Label & SDS Output Alignment

## Experiments

- **Most Important Uncertainty:** Will SME chemical formulators, lubricant blenders, detergent manufacturers, and distributors pay for this solution before expense?
- **Riskiest Assumption:** Dominant incumbents (Lisam, Sphera) occupying enterprise SDS authoring workflows
- **Cheapest Test:** Run label-vs-SDS diffs for 15 mid-sized chemical blenders
- **Fastest Test:** Direct outreach to 10 prospective buyers with an immediate delivery pilot.

### Interview Plan
- Interview 15 target buyers (SME chemical formulators, lubricant blenders, detergent manufacturers, and distributors).
