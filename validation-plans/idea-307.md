# Validation Plan — Connected-Vehicle Origin Graph — MY2027 Vehicle Software Origin Compliance

## Experiments

- **Most Important Uncertainty:** Will Tier-1 automotive suppliers, EV manufacturers, and automotive compliance counsel pay for this solution before expense?
- **Riskiest Assumption:** Long enterprise sales cycles with Tier-1 automotive procurement departments
- **Cheapest Test:** Interview 5 automotive supply chain directors on MY2027 software origin readiness
- **Fastest Test:** Direct outreach to 10 prospective buyers with an immediate delivery pilot.

### Interview Plan
- Interview 15 target buyers (Tier-1 automotive suppliers, EV manufacturers, and automotive compliance counsel).
