# Validation Plan — Finance Control Red Team — Synthetic Transaction Fraud & ERP Separation Tester

## Experiments

- **Most Important Uncertainty:** Will Chief Financial Officers, corporate controllers, internal audit leads, and enterprise ERP teams pay for this solution before expense?
- **Riskiest Assumption:** Complex enterprise ERP integration requirements (SAP/Oracle/NetSuite)
- **Cheapest Test:** Run synthetic vendor-bank-change audits for 5 mid-market UK corporate finance teams
- **Fastest Test:** Direct outreach to 10 prospective buyers with an immediate delivery pilot.

### Interview Plan
- Interview 15 target buyers (Chief Financial Officers, corporate controllers, internal audit leads, and enterprise ERP teams).
