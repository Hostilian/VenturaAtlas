# Validation Plan — APP Reimbursement Replay — Synthetic Scam Claim & Multi-Bank Clock Simulator

## Experiments

- **Most Important Uncertainty:** Will UK payment service providers, challenger banks, electronic money institutions (EMIs), and fraud ops teams pay for this solution before expense?
- **Riskiest Assumption:** High industry baseline reimbursement performance reducing urgency for smaller PSPs
- **Cheapest Test:** Simulate 20 synthetic APP claim scenarios for 5 UK challenger EMIs
- **Fastest Test:** Direct outreach to 10 prospective buyers with an immediate delivery pilot.

### Interview Plan
- Interview 15 target buyers (UK payment service providers, challenger banks, electronic money institutions (EMIs), and fraud ops teams).
