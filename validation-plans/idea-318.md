# Validation Plan — ETIAS Carrier Preflight — Travel Authorization Pre-Boarding Exception Checker

## Experiments

- **Most Important Uncertainty:** Will Regional airlines, charter flight operators, cruise lines, and maritime passenger carriers pay for this solution before expense?
- **Riskiest Assumption:** Shifting EU implementation timelines undermining buyer urgency
- **Cheapest Test:** Interview 5 regional charter airline operations managers on ETIAS pre-boarding readiness
- **Fastest Test:** Direct outreach to 10 prospective buyers with an immediate delivery pilot.

### Interview Plan
- Interview 15 target buyers (Regional airlines, charter flight operators, cruise lines, and maritime passenger carriers).
