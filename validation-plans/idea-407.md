# Validation Plan — AidGraph -- Public Money Graph Platform

## Experiments

- **Most Important Uncertainty:** Will Grant consultants, subsidy advisers, and B2B sales intelligence teams pay for this solution before expense?
- **Riskiest Assumption:** Governments intend to automate group-resolution by 2029. Pure calculator has known half-life. Must grow toward durable intelligence layer.
- **Cheapest Test:** Sell 3 prepaid AidHeadroom EUR99 audits to grant consultants before writing any code.
- **Fastest Test:** Direct outreach to 10 prospective buyers with an immediate delivery pilot.

### Interview Plan
- Interview 15 target buyers (Grant consultants, subsidy advisers, and B2B sales intelligence teams).
