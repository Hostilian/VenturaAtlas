# Validation Plan — AidHeadroom -- De Minimis Group Headroom Audit

## Experiments

- **Most Important Uncertainty:** Will Independent EU grant consultants managing applications for corporate clients pay for this solution before expense?
- **Riskiest Assumption:** Official registers close gap by 2029; consultants may use Excel for simple clients; corporate-group data may become expensive
- **Cheapest Test:** Send cold message to 30-40 EU grant consultants offering De Minimis Group Headroom Audit EUR99. Require 3 prepaid audits as PASS.
- **Fastest Test:** Direct outreach to 10 prospective buyers with an immediate delivery pilot.

### Interview Plan
- Interview 15 target buyers (Independent EU grant consultants managing applications for corporate clients).
