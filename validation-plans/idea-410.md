# Validation Plan — RiceGuard -- Preferential-Tariff Safeguard PO Risk

## Experiments

- **Most Important Uncertainty:** Will Rice importers and commodity traders sourcing from GSP beneficiary countries pay for this solution before expense?
- **Riskiest Assumption:** Expert traders already understand tariffs; official customs systems may absorb; data timeliness critical; very narrow commodity scope
- **Cheapest Test:** Interview 10 EU rice importers about actual GSP tariff-surprise history and willingness to pay for pre-shipment risk alerts.
- **Fastest Test:** Direct outreach to 10 prospective buyers with an immediate delivery pilot.

### Interview Plan
- Interview 15 target buyers (Rice importers and commodity traders sourcing from GSP beneficiary countries).
