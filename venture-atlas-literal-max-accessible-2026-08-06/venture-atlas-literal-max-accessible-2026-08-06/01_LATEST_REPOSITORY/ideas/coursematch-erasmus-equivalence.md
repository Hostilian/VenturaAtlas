# CourseMatch Erasmus Equivalence

> Evidence-backed course matching and recognition packets for mobility students.
...
|---|---|
| Idea ID | `idea-038` |
| Target customer | Erasmus students |
| Problem | Students and teachers manually transform complex content into structured, validated learning workflows. |
| What to build | Evidence-backed course matching and recognition packets for mobility students. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. |
| How it makes money | student premium plan; university licenses; application support |
| Why customers pay | The customer pays because the product should produce a faster, safer, more measurable outcome than Erasmus students can obtain from current manual workarounds. |
...
| Overall opportunity score | 77.5/100 |
| Confidence | 9.3/10 |
| Main advantage | cross-university course graph and recognition evidence |
...
- **Canonical ID:** `idea-038`
- **Legacy ID:** `course-match`
- **Slug:** `coursematch-erasmus-equivalence`
- **Category:** Education technology / researched concept
- **Status:** explore
- **Tags:** Erasmus, courses, equivalence, students
- **Alternative names:** course-match, CourseMatch Erasmus Equivalence
- **Source references:** src-002, src-012
- **Provenance status:** direct or reconstructed from supplied corpus; original wording: summary

Students and teachers manually transform complex content into structured, validated learning workflows. Evidence-backed course matching and recognition packets for mobility students.
...
- **Economic Buyer:** Erasmus students

- **Daily User:** universities

- **Customer Type:** business, professional, creator, developer, consumer, or marketplace participant depending on segment

- **Current Situation:** Erasmus students currently combines manual research, spreadsheets, generic software, internal scripts, or human judgment to handle this workflow.
...
- **Functional:** Complete the workflow described by evidence-backed course matching and recognition packets for mobility students. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. with measurable evidence.
...
- **Customer Pays Because:** The customer pays because evidence-backed course matching and recognition packets for mobility students. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. can be tied to a concrete decision, release, transaction, or avoided cost.
...
### Core Features
- Evidence-backed course matching and recognition packets for mobility students. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
...
- **Mvp Definition:** One complete vertical slice that delivers evidence-backed course matching and recognition packets for mobility students. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. for one customer segment with a paid or behaviorally binding test.
...
- **Long Term Vision:** A trusted system of record and operating layer for the workflow surrounding CourseMatch Erasmus Equivalence.
...
- **Exact System:** Build a web application and bounded AI workflow for CourseMatch Erasmus Equivalence: Evidence-backed course matching and recognition packets for mobility students. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
...
- **Description:** The market consists of Erasmus students handling the recurring workflow behind students and teachers manually transform complex content into structured, validated learning workflows.
...
- **Data:** cross-university course graph and recognition evidence
...
- **Initial Niche:** Erasmus students

- **Icp:** A reachable Erasmus students experiencing the problem now, with authority or direct access to the budget owner.

- **Beachhead:** One language, platform, neighborhood, workflow, or integration where distribution is identifiable.

- **Positioning:** A specific, evidence-backed outcome for Erasmus students, not a generic AI tool.
...
- **Build Difficulty:** 3.2

- **Operational Difficulty:** 3.4
...
- **First Customer Conversation:** Interview a currently affected Erasmus students about the last occurrence and ask for a paid pilot.
...
|---|---:|---|---|
| problemSeverity | 7.6 | medium | The problem can create material delay, cost, error, lost revenue, or frustration for the named user. |
...
| marketGrowth | 7.7 | medium | Structural AI, digitization, marketplace, or information-fragmentation trends may support growth. |
...
| grossMarginPotential | 7.4 | medium | Digital delivery can produce attractive margins after human review and support are controlled. |
| speedToFirstRevenue | 8.1 | medium | A narrow paid pilot can precede full software if distribution reaches the buyer. |
| lowStartupCost | 7.9 | medium | The first validation can use static pages, open tools, and customer-funded usage. |
| easeOfMvp | 7.8 | medium | A useful vertical slice is feasible without implementing the long-term platform. |
| aiAutomationPotential | 8.9 | medium-high | AI can accelerate research, classification, generation, testing, and operations with approval gates. |
| easeOfDistribution | 6.7 | medium | There are identifiable channels, but channel access and conversion must be proven. |
...
| defensibility | 7.9 | medium | Data, integrations, workflow history, brand trust, or network density could compound. |
...
| scalability | 7.6 | medium | Software and reusable assets can scale beyond founder hours after the manual learning phase. |
| founderAccessibility | 9.1 | medium-high | The idea aligns with coding, automation, research, and AI-agent strengths. |
| regulatorySimplicity | 6.7 | medium | Risk is manageable only with explicit scope boundaries, privacy controls, and legal review where relevant. |
| operationalSimplicity | 7.6 | medium | The product can be standardized, but support, review, or partner operations may remain. |
| globalPotential | 7.8 | medium | The underlying problem can cross borders, though the initial wedge may be local or language-specific. |
| timing | 7.8 | medium | Current technical and behavioral changes create an opening, but timing evidence must be rechecked. |
| evidenceQuality | 9.2 | medium-high | The idea has recoverable source support, but most exact commercial assumptions remain unvalidated. |
| overallConfidence | 9.3 | medium-high | Confidence reflects source quality plus uncertainty in buyer behavior, distribution, and economics. |

### Composite Views

- **Overall Opportunity:** 77.5/100
- **Bootstrap Potential:** 78.5/100
- **Solo Founder Potential:** 80.9/100
- **Ai Agent Potential:** 82.2/100
- **Fastest Revenue:** 76.2/100
- **Highest Profit Potential:** 74.0/100
- **Lowest Cost Launch:** 80.6/100
- **Recurring Revenue:** 73.3/100
- **Enterprise Opportunity:** 73.6/100
- **Consumer Opportunity:** 76.3/100
- **Local Business Opportunity:** 73.7/100
- **Marketplace Opportunity:** 78.3/100
- **Long Term Defensibility:** 79.3/100
- **Nontechnical Founder:** 79.7/100
- **Technical Founder:** 80.7/100
- **Small Team:** 74.1/100
- **Little Capital:** 78.5/100
- **High Capital Available:** 76.2/100
...
- [idea-042](verified-local-value-rankings.md)
- [idea-023](applications-closing-soon.md)
- [idea-021](clip-to-quiz-language-learning.md)

## Idea-Specific Prompt Pack

See [`prompts/idea-specific/idea-038/`](../prompts/idea-specific/idea-038/README.md).
