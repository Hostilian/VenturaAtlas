# European Food Knowledge Graph

> Evidence layer connecting products, ingredients, origins, regulations, and sellers.
...
| What to build | Evidence layer connecting products, ingredients, origins, regulations, and sellers. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. |
...
| Overall opportunity score | 80.8/100 |
| Confidence | 8.5/10 |
...
- **Canonical ID:** `idea-040`
- **Legacy ID:** `food-knowledge-graph`
- **Slug:** `european-food-knowledge-graph`
- **Category:** Data infrastructure / concept
- **Status:** explore
- **Tags:** knowledge graph, food, API, ontology
- **Alternative names:** food-knowledge-graph, European Food Knowledge Graph
- **Source references:** src-002, src-012
- **Provenance status:** direct or reconstructed from supplied corpus; original wording: summary

Domain data is inconsistent, duplicated, unversioned, and difficult for software or AI to reason over. Evidence layer connecting products, ingredients, origins, regulations, and sellers.
...
- **Functional:** Complete the workflow described by evidence layer connecting products, ingredients, origins, regulations, and sellers. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. with measurable evidence.
...
- **Customer Pays Because:** The customer pays because evidence layer connecting products, ingredients, origins, regulations, and sellers. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. can be tied to a concrete decision, release, transaction, or avoided cost.
...
### Core Features
- Evidence layer connecting products, ingredients, origins, regulations, and sellers. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
...
- **Mvp Definition:** One complete vertical slice that delivers evidence layer connecting products, ingredients, origins, regulations, and sellers. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. for one customer segment with a paid or behaviorally binding test.
...
- **Long Term Vision:** A trusted system of record and operating layer for the workflow surrounding European Food Knowledge Graph.
...
- **Exact System:** Build a web application and bounded AI workflow for European Food Knowledge Graph: Evidence layer connecting products, ingredients, origins, regulations, and sellers. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
...
- **Build Difficulty:** 4.0

- **Operational Difficulty:** 4.9
...
|---|---:|---|---|
| problemSeverity | 7.9 | medium | The problem can create material delay, cost, error, lost revenue, or frustration for the named user. |
| frequencyOfNeed | 7.6 | medium | The workflow recurs often enough to support repeated use, but frequency still needs customer validation. |
| willingnessToPay | 8.3 | medium | A plausible budget owner exists, although exact willingness to pay is an assumption until prepayment. |
| marketDemand | 7.6 | medium | The underlying workflow appears broadly relevant; accessible demand is narrower than total-market rhetoric. |
| marketGrowth | 7.6 | medium | Structural AI, digitization, marketplace, or information-fragmentation trends may support growth. |
| revenuePotential | 8.1 | medium | The model has multiple revenue paths, but customer count and price remain scenario assumptions. |
| recurringRevenuePotential | 8.1 | medium | Updates, releases, monitoring, transactions, or accumulated data can create repeat use. |
| grossMarginPotential | 8.1 | medium | Digital delivery can produce attractive margins after human review and support are controlled. |
| speedToFirstRevenue | 6.5 | medium | A narrow paid pilot can precede full software if distribution reaches the buyer. |
| lowStartupCost | 6.7 | medium | The first validation can use static pages, open tools, and customer-funded usage. |
| easeOfMvp | 7.0 | medium | A useful vertical slice is feasible without implementing the long-term platform. |
...
| easeOfDistribution | 5.8 | medium | There are identifiable channels, but channel access and conversion must be proven. |
| retentionPotential | 8.1 | medium | Stored history, reruns, workflow integration, or network value may support retention. |
| competitiveAdvantage | 9.0 | medium-high | The proposed wedge is more specific than a generic tool, though competitors can respond. |
...
| scalability | 7.7 | medium | Software and reusable assets can scale beyond founder hours after the manual learning phase. |
| founderAccessibility | 9.1 | medium-high | The idea aligns with coding, automation, research, and AI-agent strengths. |
| regulatorySimplicity | 5.6 | medium | Risk is manageable only with explicit scope boundaries, privacy controls, and legal review where relevant. |
| operationalSimplicity | 6.1 | medium | The product can be standardized, but support, review, or partner operations may remain. |
| globalPotential | 7.6 | medium | The underlying problem can cross borders, though the initial wedge may be local or language-specific. |
| timing | 7.9 | medium | Current technical and behavioral changes create an opening, but timing evidence must be rechecked. |
...
| overallConfidence | 8.5 | medium-high | Confidence reflects source quality plus uncertainty in buyer behavior, distribution, and economics. |

### Composite Views

- **Overall Opportunity:** 80.8/100
- **Bootstrap Potential:** 73.4/100
- **Solo Founder Potential:** 74.9/100
- **Ai Agent Potential:** 88.2/100
- **Fastest Revenue:** 67.3/100
- **Highest Profit Potential:** 83.0/100
- **Lowest Cost Launch:** 71.4/100
- **Recurring Revenue:** 80.3/100
- **Enterprise Opportunity:** 86.2/100
- **Consumer Opportunity:** 70.4/100
- **Local Business Opportunity:** 67.2/100
- **Marketplace Opportunity:** 84.0/100
- **Long Term Defensibility:** 92.4/100
- **Nontechnical Founder:** 71.2/100
- **Technical Founder:** 87.8/100
- **Small Team:** 69.0/100
- **Little Capital:** 69.3/100
- **High Capital Available:** 81.8/100
...
- [idea-029](verified-seller-onboarding-api.md)

## Idea-Specific Prompt Pack

See [`prompts/idea-specific/idea-040/`](../prompts/idea-specific/idea-040/README.md).
