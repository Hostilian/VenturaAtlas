...
> Recommendations driven by explicit criteria, primary sources, confidence, and updates.
...
| What to build | Recommendations driven by explicit criteria, primary sources, confidence, and updates. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. |
| How it makes money | usage-based SaaS |
...
| Overall opportunity score | 86.9/100 |
| Confidence | 9.7/10 |
| Main advantage | routing outcomes, policy data, and workflow history |
...
- **Canonical ID:** `idea-015`
- **Legacy ID:** `evidence-engine`
- **Slug:** `evidence-backed-recommendation-engine`
- **Category:** AI infrastructure / concept
- **Status:** explore
- **Tags:** recommendations, evidence, ranking, AI
- **Alternative names:** evidence-engine, Evidence-Backed Recommendation Engine
- **Source references:** src-002, src-012
- **Provenance status:** direct or reconstructed from supplied corpus; original wording: summary

AI systems are fragmented, hard to govern, costly, and difficult to evaluate reliably. Recommendations driven by explicit criteria, primary sources, confidence, and updates.
...
- **Specific Problem:** AI systems are fragmented, hard to govern, costly, and difficult to evaluate reliably.
...
- **Functional:** Complete the workflow described by recommendations driven by explicit criteria, primary sources, confidence, and updates. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. with measurable evidence.
...
- **Customer Pays Because:** The customer pays because recommendations driven by explicit criteria, primary sources, confidence, and updates. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. can be tied to a concrete decision, release, transaction, or avoided cost.

- **Idea Satisfies Customer By:** The idea satisfies the customer by converting ai systems are fragmented, hard to govern, costly, and difficult to evaluate reliably. into a repeatable workflow with explicit inputs, outputs, evidence, and next actions.
...
### Core Features
- Recommendations driven by explicit criteria, primary sources, confidence, and updates. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
...
- **Mvp Definition:** One complete vertical slice that delivers recommendations driven by explicit criteria, primary sources, confidence, and updates. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. for one customer segment with a paid or behaviorally binding test.
...
- **Long Term Vision:** A trusted system of record and operating layer for the workflow surrounding Evidence-Backed Recommendation Engine.
...
- **Exact System:** Build a web application and bounded AI workflow for Evidence-Backed Recommendation Engine: Recommendations driven by explicit criteria, primary sources, confidence, and updates. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
...
- **Description:** The market consists of independent builders handling the recurring workflow behind ai systems are fragmented, hard to govern, costly, and difficult to evaluate reliably.
...
- **Data:** routing outcomes, policy data, and workflow history
...
- **Value Proposition:** Reduce the time, uncertainty, and failure risk in ai systems are fragmented, hard to govern, costly, and difficult to evaluate reliably.
...
| willingnessToPay | 8.5 | medium-high | A plausible budget owner exists, although exact willingness to pay is an assumption until prepayment. |
...
| revenuePotential | 8.6 | medium-high | The model has multiple revenue paths, but customer count and price remain scenario assumptions. |
| recurringRevenuePotential | 8.3 | medium | Updates, releases, monitoring, transactions, or accumulated data can create repeat use. |
| grossMarginPotential | 8.4 | medium | Digital delivery can produce attractive margins after human review and support are controlled. |
...
| easeOfDistribution | 7.2 | medium | There are identifiable channels, but channel access and conversion must be proven. |
| retentionPotential | 8.6 | medium-high | Stored history, reruns, workflow integration, or network value may support retention. |
| competitiveAdvantage | 8.3 | medium | The proposed wedge is more specific than a generic tool, though competitors can respond. |
| defensibility | 8.5 | medium-high | Data, integrations, workflow history, brand trust, or network density could compound. |
| dataAdvantagePotential | 8.7 | medium-high | Usage can create structured, permission-safe outcome data if collection is designed carefully. |
...
| operationalSimplicity | 7.3 | medium | The product can be standardized, but support, review, or partner operations may remain. |
| globalPotential | 8.6 | medium-high | The underlying problem can cross borders, though the initial wedge may be local or language-specific. |
| timing | 8.9 | medium-high | Current technical and behavioral changes create an opening, but timing evidence must be rechecked. |
| evidenceQuality | 9.5 | medium-high | The idea has recoverable source support, but most exact commercial assumptions remain unvalidated. |
| overallConfidence | 9.7 | medium-high | Confidence reflects source quality plus uncertainty in buyer behavior, distribution, and economics. |

### Composite Views

- **Overall Opportunity:** 86.9/100
- **Bootstrap Potential:** 78.6/100
- **Solo Founder Potential:** 80.2/100
- **Ai Agent Potential:** 89.7/100
- **Fastest Revenue:** 75.9/100
- **Highest Profit Potential:** 85.5/100
- **Lowest Cost Launch:** 74.6/100
- **Recurring Revenue:** 84.8/100
- **Enterprise Opportunity:** 85.7/100
- **Consumer Opportunity:** 81.6/100
- **Local Business Opportunity:** 77.5/100
- **Marketplace Opportunity:** 87.3/100
- **Long Term Defensibility:** 85.3/100
- **Nontechnical Founder:** 76.9/100
- **Technical Founder:** 87.7/100
- **Small Team:** 78.1/100
- **Little Capital:** 75.1/100
- **High Capital Available:** 87.0/100
...
See [`prompts/idea-specific/idea-015/`](../prompts/idea-specific/idea-015/README.md).
