# RAG Citation Fidelity Gate

> Tests whether cited answers are actually supported at the strength and location claimed.
...
|---|---|
| Idea ID | `idea-052` |
| Target customer | RAG product teams |
| Problem | A cited answer can appear trustworthy while the source does not warrant the exact proposition or confidence level. |
| What to build | A fixed release audit and regression suite for claim-to-source alignment, conflicts, abstention, and citation placement. |
| How it makes money | fixed audits; subscription regression suites; enterprise policy packs |
| Why customers pay | The customer pays because the product should produce a faster, safer, more measurable outcome than RAG product teams can obtain from current manual workarounds. |
...
| Overall opportunity score | 70.0/100 |
| Confidence | 7.1/10 |
| Main advantage | Curated failure cases, proposition-level labels, and evidence-quality history. |
| Main risk | crowded open-source evaluation market |
...
- **Canonical ID:** `idea-052`
- **Legacy ID:** `rag-citation-fidelity-gate`
- **Slug:** `rag-citation-fidelity-gate`
- **Category:** AI evaluation / finalist
- **Status:** shortlisted
- **Tags:** RAG, citations, evaluation, evidence
- **Alternative names:** rag-citation-fidelity-gate, RAG Citation Fidelity Gate
- **Source references:** src-004, src-012
- **Provenance status:** direct or reconstructed from supplied corpus; original wording: partial

A cited answer can appear trustworthy while the source does not warrant the exact proposition or confidence level. A fixed release audit and regression suite for claim-to-source alignment, conflicts, abstention, and citation placement. The initial version should be narrow, measurable, and built around an explicit paid or behavioral validation event rather than a broad platform.


## Customer Perspective

- **Primary Customer:** RAG product teams

- **Economic Buyer:** RAG product teams

- **Daily User:** knowledge-platform teams

- **Customer Type:** business, professional, creator, developer, consumer, or marketplace participant depending on segment

- **Current Situation:** RAG product teams currently combines manual research, spreadsheets, generic software, internal scripts, or human judgment to handle this workflow.

- **Specific Problem:** A cited answer can appear trustworthy while the source does not warrant the exact proposition or confidence level.
...
- **Functional:** Complete the workflow described by a fixed release audit and regression suite for claim-to-source alignment, conflicts, abstention, and citation placement. with measurable evidence.
...
- **Customer Pays Because:** The customer pays because a fixed release audit and regression suite for claim-to-source alignment, conflicts, abstention, and citation placement. can be tied to a concrete decision, release, transaction, or avoided cost.

- **Idea Satisfies Customer By:** The idea satisfies the customer by converting a cited answer can appear trustworthy while the source does not warrant the exact proposition or confidence level. into a repeatable workflow with explicit inputs, outputs, evidence, and next actions.
...
### Core Features
- A fixed release audit and regression suite for claim-to-source alignment, conflicts, abstention, and citation placement.
...
- **Mvp Definition:** One complete vertical slice that delivers a fixed release audit and regression suite for claim-to-source alignment, conflicts, abstention, and citation placement. for one customer segment with a paid or behaviorally binding test.
...
- **Long Term Vision:** A trusted system of record and operating layer for the workflow surrounding RAG Citation Fidelity Gate.
...
- **Exact System:** Build a web application and bounded AI workflow for RAG Citation Fidelity Gate: A fixed release audit and regression suite for claim-to-source alignment, conflicts, abstention, and citation placement.
...
- **Description:** The market consists of RAG product teams handling the recurring workflow behind a cited answer can appear trustworthy while the source does not warrant the exact proposition or confidence level.
...
- **Data:** Curated failure cases, proposition-level labels, and evidence-quality history.
...
- **Initial Niche:** RAG product teams

- **Icp:** A reachable RAG product teams experiencing the problem now, with authority or direct access to the budget owner.

- **Beachhead:** One language, platform, neighborhood, workflow, or integration where distribution is identifiable.

- **Positioning:** A specific, evidence-backed outcome for RAG product teams, not a generic AI tool.

- **Value Proposition:** Reduce the time, uncertainty, and failure risk in a cited answer can appear trustworthy while the source does not warrant the exact proposition or confidence level.
...
- **First Customer Conversation:** Interview a currently affected RAG product teams about the last occurrence and ask for a paid pilot.
...
| revenuePotential | 7.1 | medium | The model has multiple revenue paths, but customer count and price remain scenario assumptions. |
| recurringRevenuePotential | 7.7 | medium | Updates, releases, monitoring, transactions, or accumulated data can create repeat use. |
...
| competitiveAdvantage | 7.2 | medium | The proposed wedge is more specific than a generic tool, though competitors can respond. |
| defensibility | 7.1 | medium | Data, integrations, workflow history, brand trust, or network density could compound. |
| dataAdvantagePotential | 6.9 | medium | Usage can create structured, permission-safe outcome data if collection is designed carefully. |
| scalability | 7.0 | medium | Software and reusable assets can scale beyond founder hours after the manual learning phase. |
| founderAccessibility | 7.2 | medium | The idea aligns with coding, automation, research, and AI-agent strengths. |
...
- **Overall Opportunity:** 70.0/100
- **Bootstrap Potential:** 71.6/100
- **Solo Founder Potential:** 70.8/100
- **Ai Agent Potential:** 72.0/100
- **Fastest Revenue:** 72.9/100
- **Highest Profit Potential:** 71.6/100
- **Lowest Cost Launch:** 69.8/100
- **Recurring Revenue:** 73.8/100
- **Enterprise Opportunity:** 70.6/100
- **Consumer Opportunity:** 69.6/100
- **Local Business Opportunity:** 72.7/100
- **Marketplace Opportunity:** 70.0/100
- **Long Term Defensibility:** 70.8/100
- **Nontechnical Founder:** 70.2/100
- **Technical Founder:** 71.1/100
- **Small Team:** 69.5/100
- **Little Capital:** 71.7/100
- **High Capital Available:** 70.4/100
...
- [idea-034](founder-decision-journal.md)

## Idea-Specific Prompt Pack

See [`prompts/idea-specific/idea-052/`](../prompts/idea-specific/idea-052/README.md).
