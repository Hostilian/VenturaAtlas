# SSD Storage Culprit Analyzer

> Local read-only analysis of storage growth, duplicates, caches, and safe cleanup.
...
| What to build | Local read-only analysis of storage growth, duplicates, caches, and safe cleanup. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. |
| How it makes money | desktop license and support |
| Why customers pay | The customer pays because the product should produce a faster, safer, more measurable outcome than developers can obtain from current manual workarounds. |
...
| Overall opportunity score | 74.2/100 |
| Confidence | 8.9/10 |
| Main advantage | privacy-preserving local diagnostics and historical baselines |
...
- **Canonical ID:** `idea-048`
- **Legacy ID:** `storage-analyzer`
- **Slug:** `ssd-storage-culprit-analyzer`
- **Category:** Utilities / prompted concept
- **Status:** explore
- **Tags:** storage, Windows, local-first, cleanup
- **Alternative names:** storage-analyzer, SSD Storage Culprit Analyzer
- **Source references:** src-002, src-012
- **Provenance status:** direct or reconstructed from supplied corpus; original wording: summary

Users cannot safely understand and control complex local computer resources. Local read-only analysis of storage growth, duplicates, caches, and safe cleanup.
...
- **Economic Buyer:** developers

- **Daily User:** IT support

- **Customer Type:** business, professional, creator, developer, consumer, or marketplace participant depending on segment

- **Current Situation:** developers currently combines manual research, spreadsheets, generic software, internal scripts, or human judgment to handle this workflow.

- **Specific Problem:** Users cannot safely understand and control complex local computer resources.
...
- **Functional:** Complete the workflow described by local read-only analysis of storage growth, duplicates, caches, and safe cleanup. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. with measurable evidence.
...
- **Customer Pays Because:** The customer pays because local read-only analysis of storage growth, duplicates, caches, and safe cleanup. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. can be tied to a concrete decision, release, transaction, or avoided cost.

- **Idea Satisfies Customer By:** The idea satisfies the customer by converting users cannot safely understand and control complex local computer resources. into a repeatable workflow with explicit inputs, outputs, evidence, and next actions.
...
### Core Features
- Local read-only analysis of storage growth, duplicates, caches, and safe cleanup. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
...
- **Mvp Definition:** One complete vertical slice that delivers local read-only analysis of storage growth, duplicates, caches, and safe cleanup. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. for one customer segment with a paid or behaviorally binding test.
...
- **Long Term Vision:** A trusted system of record and operating layer for the workflow surrounding SSD Storage Culprit Analyzer.
...
- **Exact System:** Build a web application and bounded AI workflow for SSD Storage Culprit Analyzer: Local read-only analysis of storage growth, duplicates, caches, and safe cleanup. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
...
- **Description:** The market consists of developers handling the recurring workflow behind users cannot safely understand and control complex local computer resources.
...
- **Data:** privacy-preserving local diagnostics and historical baselines
...
- **Initial Niche:** developers

- **Icp:** A reachable developers experiencing the problem now, with authority or direct access to the budget owner.

- **Beachhead:** One language, platform, neighborhood, workflow, or integration where distribution is identifiable.

- **Positioning:** A specific, evidence-backed outcome for developers, not a generic AI tool.

- **Value Proposition:** Reduce the time, uncertainty, and failure risk in users cannot safely understand and control complex local computer resources.
...
- **First Customer Conversation:** Interview a currently affected developers about the last occurrence and ask for a paid pilot.
...
| marketDemand | 7.7 | medium | The underlying workflow appears broadly relevant; accessible demand is narrower than total-market rhetoric. |
| marketGrowth | 7.5 | medium | Structural AI, digitization, marketplace, or information-fragmentation trends may support growth. |
...
| recurringRevenuePotential | 6.6 | medium | Updates, releases, monitoring, transactions, or accumulated data can create repeat use. |
...
| lowStartupCost | 8.9 | medium-high | The first validation can use static pages, open tools, and customer-funded usage. |
| easeOfMvp | 9.1 | medium-high | A useful vertical slice is feasible without implementing the long-term platform. |
| aiAutomationPotential | 8.8 | medium-high | AI can accelerate research, classification, generation, testing, and operations with approval gates. |
| easeOfDistribution | 8.0 | medium | There are identifiable channels, but channel access and conversion must be proven. |
...
| defensibility | 5.7 | medium | Data, integrations, workflow history, brand trust, or network density could compound. |
| dataAdvantagePotential | 5.7 | medium | Usage can create structured, permission-safe outcome data if collection is designed carefully. |
| scalability | 7.3 | medium | Software and reusable assets can scale beyond founder hours after the manual learning phase. |
| founderAccessibility | 8.5 | medium-high | The idea aligns with coding, automation, research, and AI-agent strengths. |
| regulatorySimplicity | 9.1 | medium-high | Risk is manageable only with explicit scope boundaries, privacy controls, and legal review where relevant. |
| operationalSimplicity | 8.5 | medium-high | The product can be standardized, but support, review, or partner operations may remain. |
| globalPotential | 7.5 | medium | The underlying problem can cross borders, though the initial wedge may be local or language-specific. |
| timing | 7.6 | medium | Current technical and behavioral changes create an opening, but timing evidence must be rechecked. |
...
- **Overall Opportunity:** 74.2/100
- **Bootstrap Potential:** 84.2/100
- **Solo Founder Potential:** 86.8/100
- **Ai Agent Potential:** 77.1/100
- **Fastest Revenue:** 87.9/100
- **Highest Profit Potential:** 67.4/100
- **Lowest Cost Launch:** 88.9/100
- **Recurring Revenue:** 69.0/100
- **Enterprise Opportunity:** 65.0/100
- **Consumer Opportunity:** 78.8/100
- **Local Business Opportunity:** 83.5/100
- **Marketplace Opportunity:** 67.1/100
- **Long Term Defensibility:** 60.8/100
- **Nontechnical Founder:** 87.8/100
- **Technical Founder:** 72.7/100
- **Small Team:** 80.2/100
- **Little Capital:** 87.9/100
- **High Capital Available:** 69.9/100
...
See [`prompts/idea-specific/idea-048/`](../prompts/idea-specific/idea-048/README.md).
