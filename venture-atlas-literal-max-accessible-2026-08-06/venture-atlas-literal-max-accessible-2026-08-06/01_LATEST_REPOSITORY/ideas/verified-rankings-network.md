# Verified Rankings Network

> Transparent rankings with evidence cards, confidence, and change history.
...
| What to build | Transparent rankings with evidence cards, confidence, and change history. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. |
...
| Overall opportunity score | 85.5/100 |
| Confidence | 9.1/10 |
...
- **Canonical ID:** `idea-004`
- **Legacy ID:** `verified-rankings`
- **Slug:** `verified-rankings-network`
- **Category:** Media + data / priority
- **Status:** priority
- **Tags:** rankings, evidence, affiliate, reviews
- **Alternative names:** verified-rankings, Verified Rankings Network
- **Source references:** src-002, src-012
- **Provenance status:** direct or reconstructed from supplied corpus; original wording: summary

People make decisions from stale, biased, or incomparable information. Transparent rankings with evidence cards, confidence, and change history.
...
- **Functional:** Complete the workflow described by transparent rankings with evidence cards, confidence, and change history. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. with measurable evidence.
...
- **Customer Pays Because:** The customer pays because transparent rankings with evidence cards, confidence, and change history. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. can be tied to a concrete decision, release, transaction, or avoided cost.
...
### Core Features
- Transparent rankings with evidence cards, confidence, and change history. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
...
- **Mvp Definition:** One complete vertical slice that delivers transparent rankings with evidence cards, confidence, and change history. the product should keep inputs, evidence, decisions, outputs, and change history structured and auditable. for one customer segment with a paid or behaviorally binding test.
...
- **Long Term Vision:** A trusted system of record and operating layer for the workflow surrounding Verified Rankings Network.
...
- **Exact System:** Build a web application and bounded AI workflow for Verified Rankings Network: Transparent rankings with evidence cards, confidence, and change history. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
...
- **Build Difficulty:** 2.2

- **Operational Difficulty:** 2.2
...
| frequencyOfNeed | 8.5 | medium-high | The workflow recurs often enough to support repeated use, but frequency still needs customer validation. |
...
| marketGrowth | 8.7 | medium-high | Structural AI, digitization, marketplace, or information-fragmentation trends may support growth. |
| revenuePotential | 8.4 | medium | The model has multiple revenue paths, but customer count and price remain scenario assumptions. |
...
| grossMarginPotential | 8.6 | medium-high | Digital delivery can produce attractive margins after human review and support are controlled. |
| speedToFirstRevenue | 10 | medium-high | A narrow paid pilot can precede full software if distribution reaches the buyer. |
| lowStartupCost | 8.7 | medium-high | The first validation can use static pages, open tools, and customer-funded usage. |
| easeOfMvp | 8.8 | medium-high | A useful vertical slice is feasible without implementing the long-term platform. |
| aiAutomationPotential | 9.5 | medium-high | AI can accelerate research, classification, generation, testing, and operations with approval gates. |
...
| regulatorySimplicity | 9.0 | medium-high | Risk is manageable only with explicit scope boundaries, privacy controls, and legal review where relevant. |
| operationalSimplicity | 8.8 | medium-high | The product can be standardized, but support, review, or partner operations may remain. |
...
| evidenceQuality | 8.9 | medium-high | The idea has recoverable source support, but most exact commercial assumptions remain unvalidated. |
...
- **Overall Opportunity:** 85.5/100
- **Bootstrap Potential:** 89.8/100
- **Solo Founder Potential:** 90.4/100
- **Ai Agent Potential:** 87.5/100
- **Fastest Revenue:** 91.1/100
- **Highest Profit Potential:** 84.3/100
- **Lowest Cost Launch:** 88.6/100
- **Recurring Revenue:** 84.1/100
- **Enterprise Opportunity:** 82.2/100
- **Consumer Opportunity:** 85.8/100
- **Local Business Opportunity:** 90.1/100
- **Marketplace Opportunity:** 82.2/100
- **Long Term Defensibility:** 80.4/100
- **Nontechnical Founder:** 90.2/100
- **Technical Founder:** 85.4/100
- **Small Team:** 85.9/100
- **Little Capital:** 89.7/100
- **High Capital Available:** 83.9/100
...
- [idea-026](marketplace-trust-layer.md)

## Idea-Specific Prompt Pack

See [`prompts/idea-specific/idea-004/`](../prompts/idea-specific/idea-004/README.md).
