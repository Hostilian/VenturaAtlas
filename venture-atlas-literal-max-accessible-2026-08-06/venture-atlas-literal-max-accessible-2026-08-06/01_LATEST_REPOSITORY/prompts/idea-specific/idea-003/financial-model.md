# Financial model Prompt — AI Agent Budget & Credit Controller

You are working on **AI Agent Budget & Credit Controller**.

## Verified context supplied by the idea record
- Concept: Allocate model budgets, forecast cost, stop waste, and preserve critical work.
...
- Proposed product: Allocate model budgets, forecast cost, stop waste, and preserve critical work. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
