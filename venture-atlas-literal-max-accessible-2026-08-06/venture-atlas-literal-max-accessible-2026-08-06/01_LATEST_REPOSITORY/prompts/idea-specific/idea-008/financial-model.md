# Financial model Prompt — Research-to-Startup Engine

You are working on **Research-to-Startup Engine**.

## Verified context supplied by the idea record
- Concept: Turn deep research into ranked opportunities, experiments, and build packets.
...
- Proposed product: Turn deep research into ranked opportunities, experiments, and build packets. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
