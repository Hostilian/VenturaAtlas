# Technical Blueprint — API Opportunity Ranker

## System

- **Exact System:** Build a web application and bounded AI workflow for API Opportunity Ranker: Rank API business ideas by revenue, users, defensibility, cost, and speed. The product should keep inputs, evidence, decisions, outputs, and change history structured and auditable.
